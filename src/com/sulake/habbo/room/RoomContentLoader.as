package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_1007:String = "RCL_LOADER_READY";
      
      private static const const_389:String = "RCL_PUBLICROOM_";
      
      private static const const_2109:int = 0;
      ...
      private static const const_702:String = "wall_place_holder";
      
      private static const const_701:String = "pet_place_holder";
      ...
      private static const const_1111:String = "selection_arrow";
      ...
      private var var_1570:IEventDispatcher = null;
      ...
      private var var_223:PublicRoomData = null;
      
      private var var_1569:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2731 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2733 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1110)
         {
            return;
         }
         this.var_1570 = param1;
         this.var_2729 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2730 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_423.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_846.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_460.add(_loc3_,_loc4_);
               if(this.var_398[_loc7_] == null)
               {
                  this.var_398[_loc7_] = 1;
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2732)
         {
            ...
            {
               this.var_1570.dispatchEvent(new Event(const_1007));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_562 != null)
         {
            this.var_562.remove(param2);
            this.var_562.add(param2,param1);
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_223 != null && (this.var_223.type == param1 || this.var_223.hasWorldType(param1)))
         {
      ...
      {
         return [const_477,const_702,const_701,const_700,TILE_CURSOR,const_1111];
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_846.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_223 != null && this.var_223.hasWorldType(const_389 + param1))
         {
            return this.var_223.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_270 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_398[_loc4_] == null)
                     {
                        this.var_398[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1569.getValue(param1) != null)
         {
            this.var_223 = this.var_1569.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2731.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1855);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2733.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_550,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1569.add(param1,_loc4_);
         this.var_223 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_845.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_845.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_845.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_582.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_223.getWorldHeightScale(const_389 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_223 != null)
         {
            return this.var_223.getWorldScale(const_389 + param1);
         }
         return 32;
      }
