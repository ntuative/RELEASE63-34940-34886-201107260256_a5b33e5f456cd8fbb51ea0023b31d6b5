package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1049:int = 15;
      
      private static const const_1050:int = 31;
      
      private static const const_1439:int = 2;
      
      private static const const_1438:int = 1;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1164[param2];
         var _loc4_:int = this.var_1162[param2];
         var _loc5_:int = this.var_1165[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1164.push(Math.random() * _loc2_ * 1.5);
         this.var_1164.push(Math.random() * _loc2_ * 1.5);
         this.var_1162 = new Array();
         this.var_1162.push(1);
         this.var_1162.push(-1);
         this.var_1165 = new Array();
         this.var_1165.push(const_1439);
         this.var_1165.push(const_1438);
