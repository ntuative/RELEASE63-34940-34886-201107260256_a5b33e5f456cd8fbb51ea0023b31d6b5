package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1776:int = 16777215;
      
      public static const const_2022:int = 13421772;
      ...
      public static const const_1915:int = 16777215;
      
      public static const const_1866:int = 13421772;
      
      public static const const_1770:int = 10066329;
      ...
      private var var_1019:Number = NaN;
      
      private var var_1449:Number = NaN;
      
      private var var_2351:Number = NaN;
      ...
      private var var_2352:int = 255;
      
      private var var_2354:int = 255;
      ...
      private const const_2369:int = 250;
      ...
      private var var_2353:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_321["null"] = false;
         this.var_321["null"] = true;
         this.var_321["null"] = true;
         this.var_321["null"] = true;
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1019))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1019;
         }
         if(!isNaN(this.var_1449))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1449;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_974);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1377);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_278)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1776;
               }
               else
               {
                  _loc13_.color = const_2022;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_433)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1915;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1866;
               }
               else
               {
                  _loc13_.color = const_1770;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1779)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_75,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_433)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2369 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_370.length)
            {
               _loc11_ = this.var_628[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_370[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1758)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2354 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2352 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2355 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1760)
         {
            this.var_1760 = param1.updateId;
            this.var_770 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1683 || _loc3_.y != this.var_2356 || _loc3_.z != this.var_2353 || param1.scale != this.var_1759))
            {
               this.var_1683 = _loc3_.x;
               this.var_2356 = _loc3_.y;
               this.var_2353 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1415);
            if(_loc3_ != this.var_1761)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1761 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_965));
            if(_loc4_ != this.var_1176)
            {
               this.var_1176 = _loc4_;
               this.var_2354 = this.var_1176 & 255;
               this.var_2352 = this.var_1176 >> 8 & 255;
               this.var_2355 = this.var_1176 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1297));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_216);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_773));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_824));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_779));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1359);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1216);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1019 || _loc3_ != this.var_1449))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1379);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2351)
            {
               this.var_2351 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      {
         if(param1 != this.var_321["null"] || param2 != this.var_321["null"] || param3 != this.var_321["null"])
         {
            this.var_321["null"] = param1;
            this.var_321["null"] = param2;
            this.var_321["null"] = param3;
            this.var_370 = [];
            this.var_628 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_370;
         if(this.var_370.length == 0)
         {
            _loc6_ = this.var_152;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_370.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_321[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1175;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_269)
                              {
