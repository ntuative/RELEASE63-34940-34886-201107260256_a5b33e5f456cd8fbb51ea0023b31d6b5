package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2202:int = 16777216;
      ...
      private var var_2118:int = 16777216;
      
      private var var_3101:int = 69069;
      
      private var var_3100:int = 5;
      ...
      {
         var _loc1_:int = this.var_3101 * this.var_2117 + this.var_3100;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2118;
         this.var_2117 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2118 * param2);
      }
   }
}
