   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2371 = param1.extra;
            this.var_1182 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1182 > 0 && param1 >= this.var_1182)
         {
            this.var_1182 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1766,String(this.var_1766),this.var_2371);
