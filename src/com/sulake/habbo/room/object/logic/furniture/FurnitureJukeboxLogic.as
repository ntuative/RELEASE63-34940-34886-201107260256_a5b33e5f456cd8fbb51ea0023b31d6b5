package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_552,RoomObjectFurnitureActionEvent.const_589,RoomObjectFurnitureActionEvent.const_671,RoomObjectFurnitureActionEvent.const_499,RoomObjectWidgetRequestEvent.const_163];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_828) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_416,RoomWidgetInfostandExtraParamEnum.const_628);
            ...
            if(_loc4_ != this.var_1362)
            {
               this.var_1362 = _loc4_;
               if(_loc4_ == 1)
               {
