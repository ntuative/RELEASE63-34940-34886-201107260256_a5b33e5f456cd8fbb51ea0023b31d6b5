package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureFloorHoleLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         if(this.var_1362 == const_486)
         {
            eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_155,object.getId(),object.getType()));
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:Array = [RoomObjectFloorHoleEvent.const_174,RoomObjectFloorHoleEvent.const_155];
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc4_ != this.var_1362)
               {
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(this.var_1362 == const_486)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_155,object.getId(),object.getType()));
                     }
                  }
