package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_2025:int = 255;
      
      private var var_1582:uint = 16777215;
      
      private var var_2023:int = 255;
      
      private var var_1296:uint = 16777215;
      
      private var var_2026:int = 255;
      
      private var var_1297:int = 0;
      
      private var var_2024:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_556,RoomObjectMouseEvent.const_178];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_974,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_965,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_773,1);
         ...
         if(this.var_1581)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_974,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1379,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1297)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_2025;
            if(_loc2_ - this.var_1297 >= this.var_2024)
            {
               _loc3_ = this.var_1296;
               _loc4_ = this.var_2026;
               this.var_1297 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1296 >> 16 & 255;
               _loc11_ = this.var_1296 >> 8 & 255;
               _loc12_ = this.var_1296 & 255;
               _loc13_ = (_loc2_ - this.var_1297) / this.var_2024;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2023 + (this.var_2026 - this.var_2023) * _loc13_;
               this._color = _loc3_;
               this.var_2025 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_965,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_813:
            ...
            case RoomObjectRoomUpdateMessage.const_1034:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_989:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_507:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_269)
               {
                  _loc5_ = "null";
               }
               this.var_521.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_1027:
               _loc4_ = this.var_521.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_521.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1415,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1339:
               param2.setNumber(RoomObjectVariableEnum.const_773,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1360:
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_696:
               param2.setNumber(RoomObjectVariableEnum.const_1359,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1275:
               param2.setNumber(RoomObjectVariableEnum.const_1216,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_174:
               ...
               this.var_1581 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_155:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1297,int(param1.bgOnly));
         this.var_1582 = this._color;
         this.var_2023 = this.var_2025;
         this.var_1296 = _loc3_;
         this.var_2026 = _loc4_;
         this.var_1297 = getTimer();
         this.var_2024 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1765,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1994,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1927,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_288 || _loc12_ == RoomPlaneData.const_433)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
