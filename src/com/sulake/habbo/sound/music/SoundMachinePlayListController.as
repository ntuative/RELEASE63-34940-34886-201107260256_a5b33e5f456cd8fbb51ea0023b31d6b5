package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_240:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_240 = param2;
         this.var_792 = [];
         this.var_792.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_792.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_792)
         {
         ...
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_739,this.onSoundMachinePlayEvent);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_1021,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_739,this.onSoundMachinePlayEvent);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_1021,this.onSoundMachineStopEvent);
               this.var_95 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_466 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_240.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_466 = -1;
         this.var_698 = false;
         this.var_240.stop(HabboMusicPrioritiesEnum.const_137);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_240.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_240.playSong(param1,HabboMusicPrioritiesEnum.const_137,_loc3_,0,0,0))
         {
