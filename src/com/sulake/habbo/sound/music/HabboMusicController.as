package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1723:int = HabboMusicPrioritiesEnum.const_137;
      ...
      private var var_603:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_792.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_792.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_792)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_960,this.onJukeboxInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_311,this.onJukeboxDispose);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_1016,this.onSoundMachineInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_994,this.onSoundMachineDispose);
         this.var_1405 = new Timer(1000);
         this.var_1405.start();
         this.var_1405.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_248)
         {
            this.var_357[_loc6_] = null;
            this.var_928[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2205)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_311)
            {
               ...
               {
                  _loc3_ = this.var_311.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_960,this.onJukeboxInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_311,this.onJukeboxDispose);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_1016,this.onSoundMachineInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_994,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_248)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_357[param1] = _loc7_;
         this.var_928[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_357[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_357[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_928[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_357.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_357[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_311.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_248)
         {
      ...
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         ...
         {
            return this.var_427.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_427.length)
         {
            return this.var_427.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_311.length)
         {
            ...
            if(_loc3_.id != this.var_1701 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_357[_loc2_] != null)
            {
               _loc3_ = this.var_357[_loc2_];
               _loc4_ = this.var_311.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_311.add(_loc6_.id,_loc10_);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_248)
         {
            return false;
         }
         ...
         this.var_2205 = this.getSongRequestCountAtPriority(param1);
         this.var_1701 = param2;
         if(this._priorityPlaying <= const_1723)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_3030 != param1.id || _loc3_ > this.var_3031 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_3030 = param1.id;
            this.var_3031 = _loc3_;
         }
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_427.add(_loc5_,_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_603 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_95,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_603 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
