package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1920:TriggerConfs;
      
      private var var_1919:ActionTypes;
      
      private var var_1921:ConditionTypes;
      
      private var var_282:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_809:RoomObjectHightLighter;
      
      private var var_201:UserDefinedRoomEventsHelp;
      
      private var var_1246:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1920 = new TriggerConfs();
         this.var_1919 = new ActionTypes();
         this.var_1921 = new ConditionTypes();
         this.var_282 = new Dictionary();
         super();
         this.var_95 = param1;
         this.var_809 = new RoomObjectHightLighter(param1);
         this.var_201 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1246 = new SliderWindowController(this.var_95,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_95.assets,0,20,1);
         this.var_1246.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1246.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_809.hideAll(this.var_282);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_809.showAll(this.var_282);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1246.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1246.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_201.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1532) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1532 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1920);
         this.refreshConfigureElement(this.var_1919);
         this.refreshConfigureElement(this.var_1921);
