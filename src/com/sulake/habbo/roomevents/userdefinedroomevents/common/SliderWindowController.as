package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1259:Number = 1.0;
      
      private var var_664:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1259,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1009);
         }
      ...
      {
         return int(this.var_1814 * (Number(param1 - this._minValue) / (this.var_1259 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1814 * (this.var_1259 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1010)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_280)
            {
               this.var_1010 = false;
            }
         }
         if(!this.var_1010 || param1.type != WindowEvent.const_450)
         {
            return;
         }
         if(this.var_664 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_664) * this.var_664;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_664 != 0)
            {
               _loc3_ = this.var_1009 + this.var_664;
      ...
      private function displaySlider() : void
      {
         ...
         {
            _loc2_.bitmap = new BitmapData(this.var_783.width,this.var_783.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_783,this.var_783.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_784 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_784.width,this.var_784.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_784,this.var_784.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_783 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_784 = BitmapData(_loc2_.content);
      }
   }
}
