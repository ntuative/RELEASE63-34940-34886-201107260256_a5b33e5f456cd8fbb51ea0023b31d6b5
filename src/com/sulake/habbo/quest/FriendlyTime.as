package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1118:int = 60;
      
      private static const const_1119:int = 3600;
      
      private static const const_1599:int = 3 * const_1118;
      
      private static const const_1598:int = 3 * const_1119;
      ...
      public static function getFriendlyTime(param1:IHabboLocalizationManager, param2:int) : String
      {
         ...
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1119));
         }
         if(param2 > const_1599)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1118));
         }
