package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1750:int = 5;
      
      private static const const_1751:int = 800;
      
      private static const const_1749:int = 15;
      
      private static const const_1748:int = 300;
      ...
      private var var_1412:QuestController;
      
      private var var_1144:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1412 = new QuestController(this);
         this.var_1144 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1750);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_423.events.removeEventListener(BadgeImageReadyEvent.const_228,this.var_1144.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_423.events.addEventListener(BadgeImageReadyEvent.const_228,this.var_1144.onBadgeImageReady);
      }
      ...
      {
         return this.var_1412.questTracker.isVisible();
      }
