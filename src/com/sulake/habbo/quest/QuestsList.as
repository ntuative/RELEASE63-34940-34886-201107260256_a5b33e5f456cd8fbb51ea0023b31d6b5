package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1537:int = 10;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_802 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_802.toggle();
         this.var_1891 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1517.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1517[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_64.spacing = const_1537;
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1891 && !this.var_1892)
            {
               this.var_1891 = false;
