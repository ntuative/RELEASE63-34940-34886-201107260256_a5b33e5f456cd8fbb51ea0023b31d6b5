package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_887:int = 1000;
      
      private static const const_691:String = "next_quest";
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this.var_50.questController.onQuest(this.var_133);
         }
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_50.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_540 ? "expanded" : "contracted"));
      ...
      private function refreshVisibility() : void
      {
         ...
         this._window.findChildByName("more_info_txt").visible = this.var_540 && this.var_50.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_540 && this.var_50.currentlyInRoom;
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_50.questController.questDetails.showDetails(this.var_133);
         }
      }
