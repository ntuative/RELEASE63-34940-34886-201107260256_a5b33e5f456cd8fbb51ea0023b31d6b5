package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_614:IAvatarRenderManager;
      
      private var var_838:ISessionDataManager;
      
      private var var_2699:FriendListLookAndFeel;
      
      private var var_486:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1982:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_674.stop();
            this.var_674.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_674 = null;
         }
         ...
         if(this.var_948)
         {
            this.var_948.release(new IIDHabboNotifications());
            this.var_948 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_838)
         {
            this.var_838.release(new IIDSessionDataManager());
            this.var_838 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1982 = new OpenedToWebPopup(this);
         }
         this.var_1982.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_95);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_409);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_341,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_614.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_948 = param2 as IHabboNotifications;
      ...
      {
         this.var_838 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1410,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_419,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_486 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_674)
         {
            this.var_674 = new Timer(120000);
            this.var_674.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_674.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_419);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_486.findTab(FriendListTab.const_95).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_486.findTab(FriendListTab.const_95);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1981.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_486.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_486.findTab(FriendListTab.const_95);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_838 || !this.var_121)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_838.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_121.vipLimit;
         }
         else if(this.var_838.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
