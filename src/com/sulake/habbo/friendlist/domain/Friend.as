package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2163:int = "F".charCodeAt(0);
      
      public static const const_2310:int = "M".charCodeAt(0);
      ...
      private var var_1328:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1016 = param1.gender;
         this.var_899 = param1.online;
         this.var_2089 = param1.followingAllowed && param1.online;
         this.var_667 = param1.figure;
         this.var_1771 = param1.motto;
         this.var_1773 = param1.lastAccess;
         this.var_1696 = param1.categoryId;
         this.var_1772 = param1.realName;
