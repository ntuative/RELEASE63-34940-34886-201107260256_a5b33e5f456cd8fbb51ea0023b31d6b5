package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_428:int = 100;
      
      public static const const_1410:int = 0;
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         while(_loc3_ < this.var_266.length)
         {
            ...
            {
               this.var_266.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_266,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1139 >= this.getPageCount())
         {
            this.var_1139 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_266.length / const_428);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1139 * const_428;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1139 + 1) * const_428,this.var_266.length);
      }
