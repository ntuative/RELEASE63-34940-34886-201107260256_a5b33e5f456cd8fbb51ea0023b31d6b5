package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1459:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1795:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1795 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1459;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1005 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_285 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1795.prepare(this.var_1005);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1421,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1405,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_826,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_765,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_826,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_765,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1474 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1474.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1792 == -1 ? 0 : int(this.var_16.height - this.var_1792);
         var _loc4_:int = this.var_1794 == -1 ? 0 : int(this.var_16.width - this.var_1794);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1390,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_826,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1421,false);
         ...
         this.var_1792 = this.var_16.height;
         this.var_1794 = this.var_16.width;
