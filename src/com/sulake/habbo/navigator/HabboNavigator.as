package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1323:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_486:Tabs;
      ...
      private var var_2848:Array;
      
      private var var_2306:RoomThumbnailRenderer;
      
      private var var_998:GuestRoomPasswordInput;
      
      private var var_329:GuestRoomDoorbell;
      
      private var var_1324:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2848 = new Array();
         ...
         this.var_1323 = new RoomCreateViewCtrl(this);
         this.var_2306 = new RoomThumbnailRenderer(this);
         this.var_998 = new GuestRoomPasswordInput(this);
         this.var_329 = new GuestRoomDoorbell(this);
         this.var_486 = new Tabs(this);
         this.var_1324 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_341,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_345.startSearch(Tabs.const_286,Tabs.const_620,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_345.startSearch(Tabs.const_273,Tabs.const_282);
         this.var_486.getTab(Tabs.const_273).tabPageDecorator.tabSelected();
      }
