package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2428:IButtonWindow;
      ...
      {
         this.var_963.visible = false;
         this.var_1784.visible = true;
         this.var_2429.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_775.setText(param1.eventDescription);
         this.var_961.setText(this.getTagFromEvent(param1,1));
         this.var_962.setText(this.getTagFromEvent(param1,2));
         this.var_1472.visible = false;
         this.var_1471.visible = true;
         this.var_1470.visible = true;
         this.var_1782.visible = false;
         this.var_1783.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_963.visible = true;
         ...
         this.var_963.selection = 0;
         this.var_1782.visible = true;
      ...
      {
         var _loc1_:int = this.var_963.selection;
         return _loc1_ + 1;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2429 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1782 = ITextWindow(this.find("create_caption"));
            ...
            this.var_2428 = IButtonWindow(this.find("cancel_button"));
            this.var_1470 = IButtonWindow(this.find("end_button"));
            this.var_963 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            this.addMouseClickListener(this.var_1472,this.onCreateButtonClick);
            this.addMouseClickListener(this.var_1471,this.onEditButtonClick);
            this.addMouseClickListener(this.var_1470,this.onEndButtonClick);
            this.addMouseClickListener(this.var_2428,this.onCancelButtonClick);
            ...
            this.var_961 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_962 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
