package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_2338 = this.var_69.textBackgroundColor;
      ...
      public function restoreBackground() : void
      {
         ...
         this.var_69.textBackgroundColor = this.var_2338;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_69.text = this.var_1474;
            this.var_625 = true;
         }
         else
         {
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.text = this.var_2337;
         this.var_625 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:WindowEvent) : void
      {
         ...
         if(_loc2_.length > this.var_1756)
         {
            this.var_69.text = _loc2_.substring(0,this.var_1756);
         }
      }
   }
}
