package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_165:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_165 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_165.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_165 != null)
         {
            this.var_165.removeEventListener(WindowEvent.const_47,this.onFilterSelected);
            this.var_165.selection = 0;
            this.var_165.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_165 == null ? 0 : int(this.var_165.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_205,Tabs.const_432);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_205,Tabs.const_973);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_205,Tabs.const_432,"" + _loc3_);
         }
         if(this.var_165)
         {
            this._navigator.trackNavigationDataPoint(this.var_165.enumerateSelection()[this.var_165.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_165 ? this.var_165.enumerateSelection()[this.var_165.selection] : null;
      }
   }
}
