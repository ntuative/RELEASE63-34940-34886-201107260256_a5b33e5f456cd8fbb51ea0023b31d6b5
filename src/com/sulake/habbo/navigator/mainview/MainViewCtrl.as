package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1569:int = 4;
      ...
      private var var_1018:PopularTagsListCtrl;
      
      private var var_1017:GuestRoomListCtrl;
      
      private var var_1270:OfficialRoomListCtrl;
      ...
      private var var_826:IRegionWindow;
      
      private var var_2649:int = 0;
      
      private var var_1269:TextSearchInputs;
      
      private var var_552:Timer;
      
      private var _disposed:Boolean = false;
      
      private var var_802:WindowToggle;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1018 = new PopularTagsListCtrl(this._navigator);
         this.var_1017 = new GuestRoomListCtrl(this._navigator);
         this.var_1270 = new OfficialRoomListCtrl(this._navigator);
         this.var_552 = new Timer(300,1);
         this.var_552.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         if(!this.var_802 || this.var_802.disposed)
         {
            this.var_802 = new WindowToggle(this.var_16,this.var_16.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_802.toggle();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_552)
            {
               this.var_552.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_552.reset();
               this.var_552 = null;
            }
            if(this.var_1018)
      ...
      private function prepare() : void
      {
         ...
         this.var_273 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         this.var_194 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_251 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_221 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_285 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1548 = this.var_16.findChildByName("loading_text");
         ...
         this.var_826 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(this.var_826 != null)
         {
            this.var_826.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onHotelViewMouseOver);
            this.var_826.addEventListener(WindowMouseEvent.const_25,this.onHotelViewMouseOut);
            this.var_826.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHotelViewMouseClick);
         }
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1824,true);
      ...
      private function createSearchInput() : void
      {
         ...
         if(this.var_1269 == null)
         {
            ...
            this.var_1269 = new TextSearchInputs(this._navigator,_loc3_);
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_221.y;
         Util.moveChildrenToColumn(this.var_194,["custom_content","list_content"],this.var_251.y,8);
         this.var_221.height = this.var_221.height + _loc1_ - this.var_221.y - this.var_285.height + this.var_2649;
         Util.moveChildrenToColumn(this.var_194,["list_content","custom_footer"],this.var_221.y,0);
         this.var_2649 = this.var_285.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1017,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1018,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1270,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_ = this.var_221.findChildByName(param4);
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_973)
         {
            return new RoomsWithHighestScoreSearchMessageComposer(this._navigator.data.adIndex);
         }
         if(param1 == Tabs.const_620)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_669 == const_1098)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_221.blend - _loc2_));
            this.var_221.blend = _loc3_;
            this.var_251.blend = !!this.var_1268 ? Number(_loc3_) : Number(1);
            this.var_285.blend = !!this.var_1268 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_669 = const_695;
            }
         }
         else if(this.var_669 == const_695)
         {
            if(this.var_1549 % 10 == 1)
            {
               this.var_1548.visible = !this.var_1548.visible;
            }
            ++this.var_1549;
            if(!this._navigator.data.isLoading())
            {
               this.var_669 = const_1097;
            }
         }
         else if(this.var_669 == const_1097)
         {
            this.refresh();
            this.var_669 = const_1569;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_1017);
      }
      ...
      {
         this._navigator.refreshButton(this.var_826,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_826,"icon_hotelview_reactive",param1,null,0);
      }
