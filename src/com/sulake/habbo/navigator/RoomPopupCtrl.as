package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2306 = new RoomThumbnailRenderer(param1);
         this.var_1092 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_195,this.var_127);
         if(this.var_127.ownerName != "" && this.var_127.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_195,!!this.var_127.event ? this.getEventCtg(this.var_127.categoryId) : this.getRoomCtg(this.var_127.categoryId));
         this.refreshRoomDesc(this.var_195,this.var_127);
         this.refreshExtraCont();
         this.refreshInfo(this.var_195,"trading_allowed",this.var_127.allowTrading);
         this.refreshInfo(this.var_195,"doormode_doorbell",this.var_127.doorMode == 1);
         this.refreshInfo(this.var_195,"doormode_password",this.var_127.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_195,this.var_127.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1092.refreshTags(_loc1_,this.var_127.tags);
         ...
         this.var_2306.refreshThumbnail(_loc1_,this.var_127.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_286,Tabs.const_403,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
