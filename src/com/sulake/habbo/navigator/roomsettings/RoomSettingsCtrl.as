package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1236:TextFieldManager;
      ...
      private var var_997:IDropMenuWindow;
      
      private var var_996:IDropMenuWindow;
      
      private var var_2564:IWindowContainer;
      ...
      {
         this.var_386 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_386));
      ...
      {
         if(param1 != this.var_386 || this.var_1237 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1237 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1811)
         {
            this.var_806.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1966)
         {
            this.var_806.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1932)
         {
            this.var_1236.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1921)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1959)
         {
         ...
         {
            this.var_998.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_806.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1236.clearErrors();
         this.var_961.clearErrors();
         this.var_962.clearErrors();
         this.var_998.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_806 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1236 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_961 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_962 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_998 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1234 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1233 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1239 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1241 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_805 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1904 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_997 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_996 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2564 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1240 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1238 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1903 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1235 = IWindowContainer(this._window.findChildByName("password_container"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1903.visible = this.var_1523;
         this.populateForm();
         if(this.var_807)
         {
            ...
            this.var_1238.height = Util.getLowestPoint(this.var_1238) + 4;
         }
         else
         {
            this.var_1240.visible = true;
            this.var_1522.visible = true;
            this.var_2564.visible = this.var_1523;
            this.var_1240.height = Util.getLowestPoint(this.var_1240) + 4;
         }
         this.var_1521.text = !!this.var_807 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1240.name,this.var_1238.name,this.var_1522.name,this.var_1903.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_806.setText(_loc1_.name);
         this.var_1236.setText(_loc1_.description);
         this.var_998.setText("");
         this.var_1234.setText("");
         ...
         {
            case RoomSettingsData.const_236:
         ...
         this.setTag(this.var_961,_loc1_.tags[0]);
         this.setTag(this.var_962,_loc1_.tags[1]);
         if(this.var_1233)
         {
            if(_loc1_.allowPets)
            {
               this.var_1233.select();
            }
            else
            {
               this.var_1233.unselect();
            }
         }
         if(this.var_1239)
         {
         ...
         {
            this.disableWindow(this.var_805);
            this.disableWindow(this.var_997);
            this.disableWindow(this.var_996);
            this.disableWindow(this.var_1904);
         }
         else
         {
            this.enableWindow(this.var_805);
            this.enableWindow(this.var_997);
            this.enableWindow(this.var_996);
            this.enableWindow(this.var_1904);
         }
         if(this.var_805)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_805.unselect();
            }
         }
         if(this.var_997)
         {
            this.var_997.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_996)
         {
            this.var_996.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_806.getText();
         _loc2_.description = this.var_1236.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_236;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_123;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_621;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_123)
         {
            _loc8_ = this.var_998.getText();
            _loc9_ = this.var_1234.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_998.clearErrors();
               this.var_1234.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1233.isSelected;
         _loc2_.allowFoodConsume = this.var_1239.isSelected;
         _loc2_.allowWalkThrough = this.var_1241.isSelected;
         _loc2_.hideWalls = this.var_805.isSelected;
         _loc2_.wallThickness = this.var_997.selection - 2;
         _loc2_.floorThickness = this.var_996.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_961,_loc2_.tags);
         this.addTag(this.var_962,_loc2_.tags);
         this.clearErrors();
         this.var_1237 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_386);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_386]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_77,HabboWindowStyle.const_31,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_386));
      }
