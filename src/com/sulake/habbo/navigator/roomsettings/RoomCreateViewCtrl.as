package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1166:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_621 = new Timer(100);
         this.var_621.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_621)
         {
            this.var_621.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_621.reset();
            this.var_621 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1166.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_64 = IItemListWindow(this.var_194.findChildByName("item_list"));
         ...
         this.var_1167 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_194.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1167.goBackToInitialState();
         this.var_1167.input.textBackgroundColor = 4294967295;
         this.var_1166 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_77,HabboWindowStyle.const_31,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1167.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1167.getText();
         var _loc3_:String = "model_" + this.var_1166.name;
