package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_797)
         {
            this.var_797 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_797)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_798)
         {
            this.var_798 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_798)
            {
               return;
            }
