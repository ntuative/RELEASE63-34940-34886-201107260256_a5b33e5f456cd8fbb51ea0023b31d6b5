package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1506:uint = 13232628;
      
      private static var var_1862:uint = 11129827;
      ...
      private var var_1861:IWindowContainer;
      ...
      private var var_1223:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_329;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_538 = param1;
         if(this.var_1863 == this.var_538)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1861 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_797)
         {
            this.var_797 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_797)
            {
               return;
            }
            this._window.content.addChild(this.var_797);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_798)
         {
            this.var_798 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_798)
            {
               return;
            }
            this._window.content.addChild(this.var_798);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_798.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_538;
         }
         this.showView(this.var_798);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_538);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_935:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1146:
               _loc4_.text = this.var_27.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1145:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1145 || param1 == ChangeUserNameResultMessageEvent.var_1146)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1223 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1223.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1506;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_538 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_538);
               break;
