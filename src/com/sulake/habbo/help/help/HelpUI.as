package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2158:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107260251));
         this.var_142 = new Map();
         this.var_142.add(HabboHelpViewEnum.const_2032,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_217,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_622,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_358,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_298,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_398,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_892,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_252,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_142.add(HabboHelpViewEnum.const_1346,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_142.add(HabboHelpViewEnum.const_1364,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_984,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_142.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_142.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_586.length == 0 || param1 != this.var_420)
            {
               this.var_586.push(this.var_420);
            }
         }
         this.var_420 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_420);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_252:
               this.showUI(HabboHelpViewEnum.const_252);
               break;
            case CallForHelpResultEnum.const_1311:
               this.showUI(HabboHelpViewEnum.const_1364);
               break;
            case CallForHelpResultEnum.const_1282:
               this.showUI(HabboHelpViewEnum.const_1346);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_142.getValue(HabboHelpViewEnum.const_217) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_568));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_142.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_142.getValue(this.var_420);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2450 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2451;
         this._window.width = _loc1_.width + this.var_2450;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_586.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_420 == HabboHelpViewEnum.const_217)
         {
            return;
         }
         if(this.var_732.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_732.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_732.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_419.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_732[1],this.var_732[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_732[0],this.var_732[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_420 == HabboHelpViewEnum.const_217 || this.var_586.length == 0)
         {
            return;
         }
         if(this.var_419 == null)
         {
            ...
            this.var_419 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_419.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_419.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_419 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_419 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_419 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
