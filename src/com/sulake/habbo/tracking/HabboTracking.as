package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1138:uint = 11;
      ...
      private var var_226:IHabboFriendList;
      
      private var var_1340:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_201:IHabboHelp;
      ...
      private var var_708:LagWarningLogger = null;
      
      private var var_471:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_708 = new LagWarningLogger();
         this.var_471 = new ToolbarClickTracker(this);
         this.var_1638 = new Array(const_1138);
         var _loc4_:int = 0;
         while(_loc4_ < const_1138)
         {
            this.var_1638[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2065,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1987,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_874,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1340)
            {
               this.var_1340.release(new IIDHabboWindowManager());
               this.var_1340 = null;
            }
            if(this.var_326)
            {
            ...
            if(this.var_226)
            {
               ...
               {
                  Component(this.var_226).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_226).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_226).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_226).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_226).events.removeEventListener(HabboFriendListTrackingEvent.const_537,this.onFriendlistTrackingEvent);
               }
               this.var_226.release(new IIDHabboFriendList());
               this.var_226 = null;
            }
            if(this.var_201)
            {
               ...
               {
                  this.var_201.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_201.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_201.release(new IIDHabboHelp());
               this.var_201 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_235,this.onRoomAdClick);
            ...
            {
               this.var_347.stop();
               this.var_347.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_347 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_145)
         {
            if(this.var_299 != null)
            {
               this.var_299.configuration = this.var_145;
            }
            if(this.var_300 != null)
            {
               this.var_300.configuration = this.var_145;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1991);
            if(this.var_145)
            {
               if(this.var_708 != null)
               {
                  this.var_708.configure(this.var_145);
               }
               if(this.var_470 != null)
               {
                  this.var_470.configure(this.var_145);
               }
               if(this.var_471 != null)
               {
                  this.var_471.configure(this.var_145);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_872,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_767,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_78,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_625,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_708 != null)
            {
               this.var_708.connection = param1;
            }
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1885);
               break;
            case HabboCommunicationEvent.const_872:
               this.trackLoginStep(HabboLoginTrackingStep.const_2038,String(this._communication.port));
               break;
      ...
      {
         this.var_1340 = IHabboWindowManager(param2);
         if(this.var_1340)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_145)
            {
               if(this.var_145.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1638)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1176);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1176,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_226 = param2 as IHabboFriendList;
         Component(this.var_226).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_226).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_226).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_226).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_226).events.addEventListener(HabboFriendListTrackingEvent.const_537,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_537:
      ...
      {
         this.var_201 = param2 as IHabboHelp;
         this.var_201.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_201.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.privateRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_874,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_235,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_326.events.addEventListener(AdEvent.const_627,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_194)
         {
            if(this.var_2108 < 1)
            {
               if(!this.var_347)
               {
                  this.var_347 = new Timer(60000,1);
                  this.var_347.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_347.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_470)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_470.frameRate),_loc2_);
                  ++this.var_2108;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_471)
         {
            this.var_471.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_471)
         {
            this.var_471.track(param1.type);
         }
      }
      ...
      {
         this.var_708.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_578 > -1 && _loc2_ < this.var_578)
         {
            ++this.var_2109;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2109);
         }
         if(this.var_578 > -1 && _loc2_ - this.var_578 > 15000)
         {
            ++this.var_2107;
         ...
         if(this.var_300 != null)
         {
            this.var_300.update(param1,this.var_578);
         }
         if(this.var_299 != null)
         {
            this.var_299.update(param1,this.var_578);
         }
         if(this.var_470 != null)
         {
            this.var_470.trackUpdate(param1,this,this.var_578);
         }
         if(this.var_708 != null)
         {
            this.var_708.update(this.var_578);
         }
      }
   }
}
