package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1595.setSelectedGridItem(this);
               this.var_1596 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1596 = false;
                  this.var_1595.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1495)
         {
            return;
         }
         this.var_1495.color = !!this.var_1500 ? uint(const_1472) : uint(const_1471);
         this.var_2377.visible = param1;
      }
