package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_244 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_244.id);
            this.var_244 = null;
         }
      }
      ...
      {
         if(this.var_244 != null || param1 == null)
         {
            return;
         }
         if(this.var_27 == null)
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_244 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_244.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_244 is FloorItem ? 1 : 2;
         this.var_2518 = _loc2_;
         this.var_2517 = this.var_244.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_244.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_244);
               break;
            case 2:
      ...
      {
         if(param1 != this.var_2518 || param2 != this.var_2517)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2443);
      }
