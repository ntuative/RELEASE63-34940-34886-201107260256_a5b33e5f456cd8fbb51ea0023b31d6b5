package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1536:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_1008 = param6;
         this.var_249 = Math.floor(this.var_1257 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1257,this.var_1008);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_29 = new BitmapData(Math.max(this.var_249 * this._thumbWidth,this.var_1257),Math.max(this.var_663 * this.var_104,this.var_1008),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_249 && this.var_29.height < _loc3_.y * this.var_104)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_249 - 1),this.var_104);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_249 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_104),null,null,true);
         _loc4_ = new Rectangle(0,this.var_104,this._thumbWidth * (this.var_249 - 1),this.var_29.height - this.var_104);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1536.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_29.height < this.var_1008)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1008);
