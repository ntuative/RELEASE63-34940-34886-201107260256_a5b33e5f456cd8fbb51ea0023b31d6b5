package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_956:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_636 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_636.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_956 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_956.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_636.scrollV;
         this.var_636.removeGridItems();
         this.var_956.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_567);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_636.addGridItem(_loc3_.window);
         ...
         while(_loc4_ < _loc5_.length)
         {
            ...
            this.var_956.addGridItem(_loc3_.window);
      ...
      {
         var _loc2_:int = this.var_636.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_956.getGridItemIndex(param1.window);
