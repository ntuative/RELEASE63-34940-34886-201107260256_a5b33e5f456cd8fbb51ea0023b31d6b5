package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1469:int = 100;
      ...
      private var var_1458:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_441 = [];
         this.var_440 = [];
         this.var_632 = new Timer(const_1469,1);
         this.var_632.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2373 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_632.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_632.stop();
               this.var_632 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_38)
            {
               ...
               {
                  this.var_1458 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1458;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_384)
         {
         ...
         if(this.var_773 == null)
         {
            this.var_773 = this._windowManager.buildFromXML(this.var_2373) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_773.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_773.clone() as IWindowContainer;
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_438);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_633.add(const_38,new Array());
         this.var_633.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_38;
            _loc5_ = this.var_441.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_440.indexOf(param1.ref) > -1;
         }
      ...
      {
         return getTimer() < this.var_2375 + const_1470;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_385;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_356 || _loc3_.category == FurniCategory.const_367 || _loc3_.category == FurniCategory.const_384)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               ...
               if(_loc4_.category == FurniCategory.const_894)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_441.indexOf(_loc2_) == -1)
            {
               this.var_441.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_440.indexOf(_loc2_) == -1)
            {
               this.var_440.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_457:
               return this.var_441.length;
            case UnseenItemCategoryEnum.const_455:
               return this.var_440.length;
            default:
               return this.var_441.length + this.var_440.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_440 && this.var_440.length > 0)
               {
               ...
               break;
            case const_38:
               if(this.var_441 && this.var_441.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_457));
                  this.var_441 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
