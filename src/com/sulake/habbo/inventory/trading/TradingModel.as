package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_2006:uint = 9;
      ...
      public static const const_327:uint = 3;
      
      public static const const_631:uint = 4;
      
      public static const const_271:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_2840 = param5;
         this.var_1061 = new Map();
         this.var_1319 = false;
         this.var_1835 = param6;
         this.var_873 = true;
         this.state = const_224;
         this.var_59.setup(param1,param3,param4,param6);
         this.var_59.updateItemList(this.var_866);
         this.var_59.updateItemList(this.var_1619);
      ...
      public function close() : void
      {
         if(this.var_873)
         {
            if(this._state != const_212 && this._state != const_271)
            {
      ...
      {
         this.var_59.setMinimized(param1 != InventoryCategory.const_70);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_865 + " OTHER: " + this.var_1319);
         ...
         {
            case const_212:
               if(param1 == const_224 || param1 == const_271)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = this.var_296.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_59.alertPopup(TradingView.const_1232);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_866)
            {
               this.var_865 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1319 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_59.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_866)
            {
               this.var_59.alertPopup(TradingView.const_1309);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_296.length < const_2006)
         {
         ...
         else
         {
            ...
            if(this.var_296.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
