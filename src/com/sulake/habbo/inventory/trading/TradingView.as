package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1173:uint = 4284532064;
      
      private static const const_1172:uint = 2577770;
      ...
      private var var_752:ItemPopupCtrl;
      ...
      private var var_1141:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_752 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_236)
            {
               this.var_236.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_236.stop();
               this.var_236 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2215 = this.createMinimizedWindow();
         }
         if(!this.var_1161)
         {
            return this.var_81;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_81)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1173) : uint(const_1172);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1173) : uint(const_1172);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_236 = new Timer(1000,3);
            this.var_236.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_236.reset();
         this.var_236.repeatCount = 3;
         this.var_236.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_236.currentCount));
         if(this.var_236.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1141)
         {
            this.var_1141.isSelected = false;
            this.var_1141 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1858)
            {
            ...
            this.var_752.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_518);
            this.var_752.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_752.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_211.push(param4);
            this.var_211.push(param1);
            this.var_211.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_211.length > 0)
         {
            _loc2_ = this.var_211.pop();
            _loc3_ = this.var_211.pop();
            _loc4_ = uint(this.var_211.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_752.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_518);
               }
            }
            else
            {
               this.var_211.push(_loc4_);
               this.var_211.push(_loc3_);
