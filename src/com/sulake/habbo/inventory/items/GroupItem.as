package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1471:int = 13421772;
      
      private static const const_1472:int = 10275685;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2377 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_3056 = param6;
         this.var_2264 = param7;
         this._items = new Map();
         this.var_2262 = param2;
         this._category = param3;
         this.var_2263 = param8;
         this.var_1553 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2262 == FurniModelCategory.const_38)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1553));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2263);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_894)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         this.var_1495.color = !!this.var_1463 ? uint(const_1472) : uint(const_1471);
         this.var_2377.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2264 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3056;
               _loc5_.visible = true;
            }
            else
            {
