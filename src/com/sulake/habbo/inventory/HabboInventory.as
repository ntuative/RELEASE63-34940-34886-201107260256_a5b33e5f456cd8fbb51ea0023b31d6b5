package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2400:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_633,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_66.getValue(InventoryCategory.const_70));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_66.getValue(InventorySubCategory.const_385));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_66.getValue(InventoryCategory.const_156));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_66.getValue(InventoryCategory.const_220));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_66.getValue(InventorySubCategory.const_1290));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_66.getValue(InventoryCategory.const_127));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_66.getValue(InventoryCategory.const_438) as MarketplaceModel;
      }
      ...
      {
         return this.var_117.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_117.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_117.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_117.clubHasEverBeenMember;
      }
      
      public function get clubIsExpiring() : Boolean
      {
         return this.var_117.clubIsExpiring;
      }
      ...
      {
         this.var_117.clubPeriods = param1;
         this.var_117.clubDays = param2;
         this.var_117.clubHasEverBeenMember = param3;
         this.var_117.isVIP = param4;
         this.var_117.clubIsExpiring = param5;
      ...
      {
         this.var_423 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_633,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_83:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_633:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_423 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_66.add(InventoryCategory.const_438,_loc1_);
         ...
         this.var_66.add(InventoryCategory.const_70,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_423);
         this.var_66.add(InventoryCategory.const_220,_loc3_);
         ...
         this.var_66.add(InventoryCategory.const_156,_loc4_);
         ...
         this.var_66.add(InventorySubCategory.const_385,_loc5_);
         ...
         this.var_66.add(InventorySubCategory.const_1290,_loc6_);
         ...
         this.var_66.add(InventoryCategory.const_127,_loc7_);
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_385:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1094.indexOf(param1) == -1)
            {
               this.var_1094.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_1094.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1094.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1094.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2400);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_246));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2921)
         {
            this.var_2921 = _loc1_;
