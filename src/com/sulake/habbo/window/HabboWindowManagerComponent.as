package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1594:uint = 1;
      ...
      private var var_1577:IEventDispatcher;
      
      private var var_1292:Boolean = false;
      
      private var var_2019:ProfilerOutput;
      
      private var var_1576:ProfilerAgentTask;
      
      private var var_1578:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_224 = new Array(const_478);
         ...
         this.var_715 = this.var_224[const_1594];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2019)
            {
               this.var_2019 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2019.profiler = _loc3_;
            this.var_1576 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1576);
            this.var_1578 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1578);
            this.var_1292 = true;
         }
      }
      ...
      {
         return this.var_715.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_715.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_224[param1].getDesktopWindow().getChildAt(this.var_715.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_430.length > 0)
         {
            this.var_1577.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_478 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1577.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_430.length > 0)
         {
            WindowContext.var_430.flush();
         }
         MouseCursorControl.change();
         this.var_1577.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1958,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1951,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1795,new Date().getTime().toString());
