package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_519:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_519 = new UserInfoCtrl(this._window,this.var_72,_loc3_.message);
         this.var_1168 = new UserInfoCtrl(this._window,this.var_72,_loc3_.message);
         this.var_519.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1168.load(_loc4_,this.var_171.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_72 != null && this.var_72.issueManager != null && this.var_171 != null)
         {
            this.var_72.issueManager.removeHandler(this.var_171.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_72.issueManager.closeBundle(this.var_171.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_72.issueManager.closeBundle(this.var_171.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_72.issueManager.closeBundle(this.var_171.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_72.issueManager.releaseBundle(this.var_171.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_72.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_72,WindowTracker.const_1270,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_519 = new UserInfoCtrl(this._window,this.var_72,_loc3_.message);
            this.var_519.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
