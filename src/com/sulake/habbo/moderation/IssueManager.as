package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1299:String = "issue_bundle_open";
      
      public static const const_806:String = "issue_bundle_my";
      
      public static const const_1265:String = "issue_bundle_picked";
      
      public static const const_1884:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_675 = new IssueBrowser(this,this.var_72.windowManager,this.var_72.assets);
         this.var_1281 = [];
         this.var_1280 = [];
         this.var_1033 = new Map();
         this.var_2710 = parseInt(this.var_72.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1991 = new Timer(const_1884,0);
         this.var_1991.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1991.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1281 = this.var_1281.concat(_loc4_.getIssueIds());
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_426 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1280 = this.var_1280.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_72.soundManager.playSound(HabboSoundTypesEnum.const_1224);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1881)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_806);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1280.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2710);
            }
         }
         ...
         for each(_loc4_ in this.var_123)
         {
            switch(param1)
            {
               case const_1299:
                  ...
                  break;
               case const_806:
                  if(_loc4_.state == IssueMessageData.const_426 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_426 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
