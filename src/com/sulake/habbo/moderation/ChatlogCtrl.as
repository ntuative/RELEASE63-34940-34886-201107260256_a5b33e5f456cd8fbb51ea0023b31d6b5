package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1054:Array = [];
      
      private static var var_2069:int = 1000;
      
      private static var var_1053:Array = [];
      
      private static var var_2068:int = 200;
      ...
      private var var_2066:IMessageComposer;
      ...
      {
         this.var_860 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_861 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_552 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_2066);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1054.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_861.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1054.length < var_2069)
         {
            ...
            param1.width = this.var_861.width;
            param1.height = this.var_861.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1053.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_860.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1053.length < var_2068)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_860.width;
            param1.height = this.var_860.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2067[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1608.getValue(param2.chatterName))
            {
               this.var_1608.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1608.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1609)
         {
