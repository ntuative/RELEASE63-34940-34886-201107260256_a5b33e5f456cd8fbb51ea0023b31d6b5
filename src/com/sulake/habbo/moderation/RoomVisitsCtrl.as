package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1020:Array = [];
      
      private static var var_1960:int = 200;
      ...
      {
         this.var_833 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1020.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_833.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1020.length < var_1960)
         {
            ...
            param1.width = this.var_833.width;
            param1.height = this.var_833.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1555)
         {
