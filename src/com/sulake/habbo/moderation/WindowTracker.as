package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_2036:int = 2;
      ...
      public static const const_1783:int = 6;
      
      public static const const_1828:int = 7;
      ...
      private var var_2214:Dictionary;
      ...
      {
         var _loc2_:Dictionary = this.var_2214[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2214[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
