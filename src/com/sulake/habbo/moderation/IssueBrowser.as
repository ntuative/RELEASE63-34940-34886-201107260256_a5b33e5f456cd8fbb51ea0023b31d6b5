package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2405:String = "closed_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_368 == _loc2_)
         {
            return;
         }
         if(this.var_368 != null)
         {
            this.var_368.visible = false;
         }
         this.var_368 = _loc2_;
         if(this.var_368 == null)
         {
         ...
         this.var_368.view.width = this.var_273.container.width;
         this.var_368.view.height = this.var_273.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2365:
               ...
               {
                  this.var_1741 = new MyIssuesView(this.issueManager,this,this.var_273.container);
               }
               return this.var_1741;
            case this.const_2364:
               if(this.var_1742 == null)
               {
                  this.var_1742 = new OpenIssuesView(this.issueManager,this,this.var_273.container);
               }
               return this.var_1742;
            case this.const_2366:
               if(this.var_1743 == null)
               {
                  this.var_1743 = new PickedIssuesView(this.issueManager,this,this.var_273.container);
               }
