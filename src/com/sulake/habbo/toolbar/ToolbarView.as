package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1459:Point = new Point(3,3);
      
      private static const const_1734:uint = 7433577;
      
      private static const const_1729:uint = 5723213;
      
      private static const const_491:String = "_hover";
      
      private static const const_490:String = "_normal";
      
      private static const const_492:int = 5;
      
      private static const const_1736:int = 600;
      
      private static const const_1733:int = 80;
      
      private static const const_1732:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1730:int = -2;
      
      private static const const_1731:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1459;
         this._window.addEventListener(WindowEvent.const_531,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_490);
         }
         ...
         this.var_234 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_234);
         var _loc14_:ITextWindow = this.var_234.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_234.x = _loc13_.width - this.var_234.width - const_492;
         this.var_234.y = const_492;
         this.var_3035 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1736;
         if(!param1 && _loc2_ == this.var_1707)
         {
            return;
         }
         this.var_1707 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1732) : int(const_1733);
         var _loc4_:int = !!_loc2_ ? int(const_1730) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1731 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1735;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_234 != null && this.var_3035)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_943:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_866:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_491);
               this.setIconBgHoverState(_loc3_,const_491);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_491 ? this.var_1705 : this.var_1706;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_491)
         {
            param1.color = const_1734;
         }
         else
         {
            param1.color = const_1729;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1707 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1707 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1706 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1705)
         {
            this.var_1705.dispose();
         }
         this.var_1705 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1134.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_492;
            _loc2_.y = const_492;
            this.var_1134.add(param1,_loc2_);
         }
         return _loc2_;
      }
