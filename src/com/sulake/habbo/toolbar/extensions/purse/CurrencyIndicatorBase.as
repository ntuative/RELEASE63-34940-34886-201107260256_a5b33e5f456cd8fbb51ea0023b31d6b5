package com.sulake.habbo.toolbar.extensions.purse
{
   ...
   public class CurrencyIndicatorBase implements ICurrencyIndicator
   {
      ...
      private var var_2291:String = null;
      ...
      protected function createWindow(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(this._view)
            {
               ...
               {
                  this.var_618 = _loc4_[0] as IBitmapWrapperWindow;
      ...
      protected function animateIcon(param1:int) : void
      {
         ...
         if(this.var_618 && this.var_272.length > 0)
         {
            if(this.var_1732 == ANIM_DIRECTION_FORWARD)
            {
               this.var_271 = 0;
            }
            else
            {
               this.var_271 = this.var_272.length - 1;
            }
            this.var_617 = new Timer(this.var_2288,this.var_272.length);
      ...
      protected function setText(param1:String) : void
      {
         if(this._view)
         {
            this._view.findChildByName(this.var_1731).caption = param1;
            this._view.findChildByName(this.var_1733).caption = param1;
         }
      }
      ...
      protected function setTextUnderline(param1:Boolean) : void
      {
         ...
         if(this._view)
         {
            _loc2_ = this._view.findChildByName(this.var_1731) as ITextWindow;
            _loc3_ = this._view.findChildByName(this.var_1733) as ITextWindow;
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         if(this.var_618 && this.var_272.length > 0)
         {
            this.setIconBitmap(this.var_272[this.var_271]);
            if(this.var_1732 == ANIM_DIRECTION_FORWARD)
            {
               ++this.var_271;
               this.var_271 = this.var_271 < this.var_272.length ? int(this.var_271) : int(this.var_272.length - 1);
            }
            else
            {
               --this.var_271;
               this.var_271 = this.var_271 >= 0 ? int(this.var_271) : 0;
            }
         }
      }
      ...
      private function setIconBitmap(param1:BitmapData) : void
      {
         if(this.var_618)
         {
            this.var_618.bitmap = param1.clone();
            this.var_618.width = param1.width;
            this.var_618.height = param1.height;
