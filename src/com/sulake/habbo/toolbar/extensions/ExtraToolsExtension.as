package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1479:uint = 12247545;
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_411 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_64.removeListItem(this.var_411);
      }
      
      public function showRoomInfo() : void
      {
         this.var_64.addListItemAt(this.var_411,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_324)
         {
            this.var_324 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_324.x = _loc1_.x + this._window.width - this.var_324.width;
            this.var_324.y = _loc1_.y + this._window.height - this.var_324.height;
         }
      }
