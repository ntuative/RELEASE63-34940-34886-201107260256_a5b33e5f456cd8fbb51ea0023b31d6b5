package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1694:String = "purse";
      
      private static const const_1695:String = "extra_tools";
      ...
      private var var_736:ExtraToolsExtension;
      ...
      private var var_1689:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_737:ExtensionView;
      ...
      {
         if(this.var_284 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_737 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_737)
            {
               ...
               this.var_736 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1689 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_737.attachExtension(const_1694,this.var_1387.window,ExtensionFixedSlotsEnum.const_2015);
               this.var_737.attachExtension(const_1695,this.var_736.window,ExtensionFixedSlotsEnum.const_1849);
            }
         }
         if(this._view == null)
         {
