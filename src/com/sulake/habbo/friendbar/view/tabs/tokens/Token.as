package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_1080:String = "title";
      
      protected static const const_1059:String = "message";
      
      protected static const const_1431:Rectangle = new Rectangle(0,0,25,25);
      ...
      protected var var_1428:FriendNotification;
      
      protected var var_1151:DropAnimation;
      ...
      {
         return this.var_1428.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1428.viewOnce;
      }
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._window.findChildByName(const_1059).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1438.create("ICON_" + this.typeCode,WindowType.const_338,WindowStyle.const_103,WindowParam.const_30,Token.const_1431) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1438.create("BITMAP_" + this.typeCode,WindowType.const_417,WindowStyle.const_103,WindowParam.const_185,Token.const_1431) as IBitmapWrapperWindow;
         ...
         if(param6)
         {
            this.var_1151 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
