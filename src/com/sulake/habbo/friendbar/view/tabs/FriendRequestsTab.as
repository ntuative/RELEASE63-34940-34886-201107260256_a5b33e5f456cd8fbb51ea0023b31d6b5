package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2086:String = "badge_counter";
      
      protected static const const_2088:String = "button_accept_all";
      ...
      private static var var_1699:FriendRequestsTab;
      
      private static const const_69:uint = 4294625561;
      
      private static const const_1064:uint = 4294957414;
      
      private static const const_1609:uint = 4289431312;
      
      private static const const_1602:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1699 ? var_1699 : new FriendRequestsTab();
         _loc2_.var_167 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2086).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2200)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1401.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1609) : uint(const_1602);
                           ...
                           _loc9_ = var_506.getAvatarFaceBitmap(_loc5_.figure);
                           if(_loc9_)
                           {
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         this.var_1401 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1045)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1046)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1437)).textColor = const_1715;
            }
         }
      }
