package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2089:String = "friend_request_tab_xml";
      
      protected static const const_469:String = "bubble";
      
      protected static const const_1059:String = "message";
      
      protected static const const_2084:String = "button_accept";
      
      protected static const const_1428:String = "button_close";
      
      protected static const const_1047:String = "click_region_reject";
      
      protected static const REGION_REJECT_TEXT:String = "link_reject";
      
      private static const const_69:uint = 16435481;
      
      private static const const_1064:uint = 16767334;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1715:uint = 16777215;
      
      private static var var_1699:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1699 ? var_1699 : new FriendRequestTab();
         ...
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               ...
               _loc3_.bitmap = var_506.getAvatarFaceBitmap(param1.figure);
            }
         }
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2089).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_338,WindowStyle.const_103,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_417,WindowStyle.const_103,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1047)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1715;
            }
         }
      }
         ...
         if(!disposed)
         {
            if(friend)
            {
               if(friend.figure == param1.figure)
               {
                  ...
                  if(_loc3_)
                  {
                     _loc4_ = var_506.getAvatarFaceBitmap(param1.figure);
                     if(_loc4_)
                     {
