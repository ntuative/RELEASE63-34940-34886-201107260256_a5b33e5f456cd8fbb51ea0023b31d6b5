package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1713:String = "entity_xml";
      
      private static const const_1712:String = "facebook_piece_xml";
      
      private static const const_1714:String = "controls_piece_xml";
      
      protected static const const_1043:String = "pieces";
      ...
      protected static const const_1059:String = "btn_message";
      ...
      protected static const const_1045:String = "label";
      
      protected static const const_611:String = "notification";
      
      private static const const_69:uint = 10338138;
      
      private static const const_1064:uint = 13891476;
      
      private static const const_1171:String = null;
      
      private static const const_737:String = "icon_tag_notify";
      
      private static const const_1711:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1043));
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_611,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1043));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1712).content as XML) as IWindowContainer;
               _loc3_.name = const_1435;
               _loc6_ = _loc3_.getChildByName(const_683) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2231.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1714).content as XML) as IWindowContainer;
               _loc3_.name = const_1434;
               _loc8_ = _loc3_.getChildByName(const_1059);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1064) : uint(const_69);
         ITextWindow(_window.findChildByTag(const_1045)).underline = exposed;
      }
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_170)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1043)).getListItemByName(const_468) as IWindowContainer;
            _loc1_.findChildByName(const_683).caption = this.var_170.name;
            var_2231.crop(_loc1_.getChildByName(const_683) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_317));
            _loc2_.bitmap = var_506.getAvatarFaceBitmap(this.var_170.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_488.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1713).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1059:
               case const_1044:
                  this.removeNotificationToken(FriendNotification.const_444,true);
                  if(var_360 && this.var_170)
                  {
                     ...
                     {
                        var_506.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1436:
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1171;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1253:
            ...
            case FriendNotification.const_1391:
               ...
               _loc5_ = const_737;
               break;
            case FriendNotification.const_444:
