package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1483:String = "add_friends_tab_xml";
      
      private static const const_1482:String = "find_friends_icon_png";
      
      private static var var_960:int = -1;
      
      private static const const_69:uint = 6907230;
      
      private static const const_1064:uint = 9209986;
      
      private static const POOL:Array = [];
      
      private static const const_470:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_470.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1483).content as XML) as IWindowContainer;
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_470.indexOf(param1) == -1)
            {
               const_470.push(param1);
            }
         }
      }
