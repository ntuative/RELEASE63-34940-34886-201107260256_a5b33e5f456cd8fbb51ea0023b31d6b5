package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1087:Boolean = false;
      
      private static const const_693:String = "Navigation";
      
      private static const const_694:String = "Friend Bar";
      
      private static const const_1554:String = "go.friendbar";
      
      private static const const_1555:String = "chat_btn_click";
      
      private static const const_1558:String = "find_friends_btn_click";
      
      private static const const_1086:String = "Toolbar";
      
      private static const const_1088:String = "open";
      
      private static const const_1089:String = "close";
      
      private static const const_1556:String = "FRIENDLIST";
      
      private static const const_1557:String = "MESSENGER";
       
      
      private var var_1000:IHabboConfigurationManager;
      ...
      private var var_387:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1000)
            {
               this.var_1000.release(new IIDHabboConfigurationManager());
               this.var_1000 = null;
            }
            if(this.var_94)
            {
            ...
            if(this.var_85)
            {
               ...
               {
                  this.var_85.events.removeEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
                  this.var_85.events.removeEventListener(FriendRequestEvent.const_234,this.onFriendRequestEvent);
               }
            ...
            if(this.var_387)
            {
               this.var_387.release(new IIDHabboEventStream());
               this.var_387 = null;
            }
            this.var_113 = null;
      ...
      {
         return this.var_331.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_693,const_694,const_1554));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_218)
         {
            ...
            if(this.var_94)
            {
               this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_693,const_694,const_1555));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_693,const_694,const_1558));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_85)
         {
            if(!this.var_85.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1086,const_1556,!!this.var_85.isOpen() ? const_1088 : const_1089));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_218)
         {
            if(!this.var_218.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1086,const_1557,!!this.var_218.isOpen() ? const_1088 : const_1089));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_387)
         {
            ...
            {
               this.var_387.visible = !this.var_387.visible;
            }
         }
      }
      ...
      public function refreshOfflineStream() : void
      {
         if(this.var_387)
         {
            if(!this.var_387.disposed)
            {
               this.var_387.refreshEventStream();
            }
         }
      }
      ...
      {
         this.var_1000 = param2 as IHabboConfigurationManager;
         this.var_2570 = this.var_1000.getBoolean("friendbar.notifications.enabled",false);
         this.var_1911 = this.var_1000.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_387 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_85 = param2 as IHabboFriendList;
         this.var_85.events.addEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
         this.var_85.events.addEventListener(FriendRequestEvent.const_234,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_331.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_331.remove(_loc8_);
               this.var_113.splice(this.var_113.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_331.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_318)
            {
               ...
               this.var_331.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_318)
            {
               if(this.var_331.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_808));
            this.makeNotification(String(this.var_808),FriendNotification.const_444,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_808));
            this.makeNotification(String(this.var_808),FriendNotification.const_444,null,true,false);
         }
      }
