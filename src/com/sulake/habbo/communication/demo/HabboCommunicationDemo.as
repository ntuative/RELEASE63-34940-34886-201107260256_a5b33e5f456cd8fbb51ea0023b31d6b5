package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_550:IKeyExchange;
      
      private var var_1013:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2627:PseudoRandom;
      ...
      private var var_250:HabboHotelView;
      
      private var var_1542:String = "";
      
      private const const_2103:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_666 = param1;
            this.var_63.initConnection(HabboConnectionType.const_259);
         }
      }
      ...
      {
         if(this.var_63 && this.var_157 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_157.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_250 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_157.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_157.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_250.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_157.getKey("use.sso.ticket") == "1";
         this.var_666 = this.var_157.getKey("sso.ticket",null);
         this.var_1939 = this.var_157.getKey("flash.client.url","");
         this.var_2628 = this.var_157.getKey("external.variables.txt","");
         if(this.var_250 == null)
         {
            this.var_250 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_63.mode = HabboConnectionType.const_96;
            if(this.var_666)
            {
               this.var_63.initConnection(HabboConnectionType.const_259);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_843,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1857);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_63.mode = HabboConnectionType.const_1365;
            }
         }
         this.var_63.initConnection(HabboConnectionType.const_259);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_872);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2627 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_63.mode)
         {
            case HabboConnectionType.const_96:
               ...
               this.var_1542 = _loc4_;
               this.var_250.loadBannerImage(_loc7_ + "?token=" + this.var_1542,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1365:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1802:
               this.var_1013 = this.generateRandomHexString(30);
               this.var_550 = new DiffieHellman(new BigInteger(this.var_157.getKey("connection.development.prime"),16),new BigInteger(this.var_157.getKey("connection.development.generator"),16));
               this.var_550.init(this.var_1013);
               _loc8_ = this.var_550.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_550.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_550.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2627);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1939,this.var_2628));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2103,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_666 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_666);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2629)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1542);
         ...
         this.var_550 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_550.init(_loc14_);
            _loc15_ = this.var_550.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1013 = _loc14_;
            }
