package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1936:uint = 1;
      
      public static const const_2059:uint = 2;
       
      
      private var var_1529:IProtocolEncoder;
      ...
      {
         super();
         this.var_1529 = new WedgieEncoder();
         this.var_1244 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1529.dispose();
