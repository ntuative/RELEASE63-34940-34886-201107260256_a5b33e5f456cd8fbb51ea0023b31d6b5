package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1083:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1547:String = "sendAccessTokenToServer";
      
      private static const const_1546:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1547,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1546,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1083);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1083);
         }
      }
