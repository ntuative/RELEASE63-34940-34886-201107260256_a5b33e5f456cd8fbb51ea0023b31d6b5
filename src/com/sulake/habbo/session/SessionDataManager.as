package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1930:GroupDetailsView;
      ...
      private var var_661:ProductDataParser;
      ...
      private var var_332:FurnitureDataParser;
      
      private var var_1933:UserTagManager;
      
      private var var_1253:BadgeImageManager;
      ...
      private var var_1254:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3088 = [];
         this.var_1933 = new UserTagManager(events);
         this.var_1256 = new HabboGroupInfoManager(this,events);
         this.var_1007 = new IgnoredUsersManager(this);
         this.var_1254 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_332)
         {
            this.var_332.removeEventListener(FurnitureDataParser.const_128,this.onFurnitureReady);
            this.var_332.dispose();
            this.var_332 = null;
         }
         if(this.var_661)
         {
            this.var_661.removeEventListener(ProductDataParser.const_128,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1253 = new BadgeImageManager(context.root.assets,events,this.var_145,this._localization);
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_332)
         {
            ...
            this.var_332 = new FurnitureDataParser(this.var_548,this._wallItems,this.var_547,this._localization);
            this.var_332.addEventListener(FurnitureDataParser.const_128,this.onFurnitureReady);
            if(this.var_145.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_145.getKey("furnidata.load.url");
               this.var_332.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_332)
         {
            this.var_332.localization = this._localization;
            this.var_332.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1931 = _loc2_.clubLevel;
         this.var_1932 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_1252 = _loc3_.respectLeft;
         this._petRespectLeft = _loc3_.petRespectLeft;
         this.var_667 = _loc3_.figure;
         this.var_1016 = _loc3_.sex;
         this.var_1772 = _loc3_.realName;
         this.var_1007.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_667 = _loc2_.figure;
            this.var_1016 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_667,this.var_1016));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2610 = _loc2_.isOpen;
         this.var_2609 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1932 >= SecurityLevelEnum.const_1296;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1933.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1253.getBadgeImage(param1);
      }
      
      public function method_3(param1:String) : BadgeInfo
      {
         return this.var_1253.method_3(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1930 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1256.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1930.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1253.getBadgeImage(param1,BadgeImageManager.const_1312);
      }
      ...
      {
         return this.var_1007.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1007.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1007.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1252 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1252 = this.var_1252 - 1;
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1255.indexOf(param1) == -1)
         {
         ...
         if(this.var_661 == null)
         {
            ...
            this.var_661 = new ProductDataParser(_loc2_,this.var_1197);
            this.var_661.addEventListener(ProductDataParser.const_128,this.onProductsReady);
         }
         return false;
      }
