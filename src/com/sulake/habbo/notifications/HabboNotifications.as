package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1676:String = "pixelbalance";
      
      private static const const_1682:String = "badges";
      
      private static const const_1681:String = "selectbadge";
      
      private static const const_1678:String = "inventory";
      
      private static const const_1683:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1679:String = "friendlist";
      
      private static const const_1680:String = "pet_inventory";
      
      private static const const_1677:String = "go_to_room";
      ...
      private var var_2155:IHabboToolbar;
      ...
      private var var_585:HabboNotificationViewManager;
      
      private var var_259:HabboAlertDialogManager;
      
      private var var_901:ParkBusDialogManager;
      
      private var var_2936:Boolean;
      
      private var var_1103:ClubGiftNotification;
      
      private var var_1104:ClubEndingNotification;
      
      private var var_1102:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1980 = false;
         this.var_3105 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1105);
         }
         var _loc6_:Map = this.var_1105["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1105["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         return this.var_1375.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1375.splice(0,1);
      ...
      {
         this.var_2155 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_585 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_2155,this.var_1105["styles"],this.var_1105["view"]);
         ...
         registerUpdateReceiver(this.var_585,1);
         registerUpdateReceiver(this,2);
         this.var_423.events.addEventListener(BadgeImageReadyEvent.const_228,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_423.userId == _loc2_.userId)
         {
      ...
      {
         this.addItem(param1,NotificationType.const_1019,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_423.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_423.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_423.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1851,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1423)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1977,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1102 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1104 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_585.isSpaceAvailable() && this.var_1375.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_585.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_585 != null)
         {
            this.var_585.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_384;
            }
            return 1;
         }
         return 1;
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_901 == null)
         {
            this.var_901 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_901 != null)
         {
            this.var_901.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1182,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1182,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1138.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2936)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1019,null);
            this.var_2936 = true;
      ...
      {
         if(param2.type == WindowEvent.const_153 || param2.type == WindowEvent.const_648)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1103 && this.var_1103.visible)
         {
            return;
         }
         this.var_1103 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_2155);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1019,_loc6_);
      }
   }
}
