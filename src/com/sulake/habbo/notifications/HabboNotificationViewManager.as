package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      public function HabboNotificationViewManager(param1:IAssetLibrary, param2:IHabboWindowManager, param3:IHabboConfigurationManager, param4:IHabboToolbar, param5:Map, param6:Map)
      {
         ...
         this._toolbar.events.addEventListener(ExtensionViewEvent.const_1330,this.refreshTopMargin);
      }
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1407,this.var_971,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_559 < this._windowManager.getDesktop(0).height;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc1_:int = this._toolbar.extensionView.screenHeight + const_489;
         ...
         while(_loc3_ < this.var_209.length)
         {
            ...
            if(_loc2_ + HabboNotificationItemView.const_559 < _loc4_.verticalPosition)
            {
               return _loc2_;
            }
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_559 + const_489;
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this._toolbar.extensionView.screenHeight + const_489;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_209.length)
         {
            _loc4_ = this.var_209[_loc3_] as HabboNotificationItemView;
