package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_1942:int = 5;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1832 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1832 = 15;
         }
         this.var_1831 = this._window.height;
         this.var_1491 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_244.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_508:
               ...
               _loc2_ = Number(this.var_1219) / Number(this.var_971["time_fade_in"]);
               if(this.var_1219 > int(this.var_971["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1076:
               ...
               if(this.var_1490 > int(this.var_971["time_display"]) && !this.var_1830)
               {
                  this.startFadeOut();
               }
               break;
            case const_1075:
               ...
               _loc3_ = 1 - Number(this.var_1220) / Number(this.var_971["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1220 > int(this.var_971["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1832;
         if(this._window.height < this.var_1831)
         {
            this._window.height = this.var_1831;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1942;
         this._window.y = this.var_1491;
      }
