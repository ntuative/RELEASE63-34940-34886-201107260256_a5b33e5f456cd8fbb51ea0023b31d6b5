package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendController
   {
      ...
      {
         this.closeConfirmation();
         this._confirmationDialog = new ClubExtendConfirmationDialog(this,this.var_105);
      ...
      public function confirmSelection() : void
      {
         ...
         this._catalog.purchaseVipMembershipExtension(this.var_105.offerId);
         this.closeConfirmation();
      }
