package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1670:String = "your_price_icon";
      
      private static const const_1672:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1668:String = "image/png";
      
      private static const const_1671:int = 2000;
      
      private static const const_1669:int = 75;
      
      protected static const const_2083:uint = 0;
      ...
      private var var_729:IRegionWindow;
      
      private var var_728:ITextWindow;
      
      private var var_418:IBitmapWrapperWindow;
      
      private var var_730:Vector.<BitmapData>;
      
      private var var_900:Timer;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_105 = param2;
         this.var_730 = new Vector.<BitmapData>(const_393);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_729)
         {
            this.var_729.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_729.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_729 = null;
         }
         if(this.var_728)
         {
         ...
         if(this.var_730)
         {
            ...
            {
               this.var_730[_loc1_].dispose();
               this.var_730[_loc1_] = null;
               _loc1_++;
            }
            this.var_730 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_729 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_728 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_729 || !this.var_728)
         {
            return;
         }
         this.var_729.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_729.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1672,const_1668,this.onTeaserLoaded);
         ...
         this.var_418 = this._view.findChildByName(const_1670) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_393)
         {
            ...
            this.var_730[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_728)
         {
            this.var_728.textColor = const_2083;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_728)
         {
            this.var_728.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_900 = new Timer(const_1671);
         this.var_900.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_900.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_418.bitmap)
         {
            this.var_418.bitmap.dispose();
         }
         if(this.var_727 < const_393)
         {
            this.var_418.bitmap = new BitmapData(this.var_418.width,this.var_418.height,true,0);
            this.var_418.bitmap.copyPixels(this.var_730[this.var_727],this.var_730[this.var_727].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_727);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_491 = new Timer(const_1669,const_393 - 1);
         this.var_491.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_491.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_491.start();
      }
