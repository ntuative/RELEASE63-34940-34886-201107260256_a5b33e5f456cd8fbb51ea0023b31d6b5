package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_736:uint = 1;
      ...
      private var var_1211:IRoomSession;
      ...
      private var var_2974:Boolean = true;
      
      private var var_2972:Boolean = true;
      
      private var var_2166:Boolean = false;
      
      private var var_2973:GiftWrappingConfiguration;
      
      private var var_1386:ClubGiftController;
      
      private var var_592:ClubBuyController;
      
      private var var_734:ClubExtendController;
      
      private var var_915:Map;
      
      private var var_1385:Boolean = false;
      
      private var var_917:IPurchasableOffer;
      
      private var var_1688:IDragAndDropDoneReceiver;
      ...
      private var var_735:RoomPreviewer;
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1877);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_423.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_592.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2971 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_423.loadProductData(this);
      }
      ...
      private function initializeRoomPreviewer() : void
      {
         if(this._roomEngine != null && this.var_145 != null && this.var_145.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_735 == null)
            {
               this.var_735 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_850 || !this.var_262 || !this.var_262.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1116 = -1;
            this.var_916 = param1;
      ...
      {
         return this.var_423.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_423.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_423.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_915.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_736) as IWindowContainer;
         ...
         _loc4_.setParamFlag(WindowParam.const_281,false);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1386 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_592 == null)
         {
            this.var_592 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_734 == null)
         {
            this.var_734 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1687 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_262.buildCatalogIndex(_loc2_);
         if(this.var_916 && this.var_916 != "")
         {
            this.var_262.openPage(this.var_916);
            this.var_916 = "";
            this.var_1116 = -1;
         }
         else if(this.var_1116 > -1)
         {
            this.var_262.openPageById(this.var_1116,this.var_2165);
            this.var_1116 = -1;
            this.var_2165 = -1;
            this.var_916 = "";
         }
         else if(this.var_1687 && this.var_2971)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_262.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1926));
         }
         else
         {
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2974 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_133,this.var_117.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2972 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1336);
         }
         this.var_2972 = false;
         if(this.var_231 != null && !this.var_231.disposed)
         {
         ...
         if(_loc2_.type == ActivityPointTypeEnum.const_751)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_378,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_378,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_117.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1422 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1386.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2973 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_592 != null)
         {
            this.var_592.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_734 != null && this.var_145.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_734.onOffer(param1);
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_915.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_915.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1211 || !this.var_1211.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_216);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1385 && param1.type == RoomEngineObjectEvent.const_161)
         {
            this.resetPlacedOfferData(true);
            if(this.var_917 == null || this.var_917.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_917.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_917);
            _loc5_ = this.var_1688;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_365,0.5);
            }
         }
      }
            ...
            if(this.var_67.roomCategory == this._roomEngine.activeRoomCategory && this.var_67.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_356:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_208);
                  ...
                  case FurniCategory.const_367:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_216);
                     if(this.var_67.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_384:
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_736);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_735 != null)
         {
            this.var_735.updatePreviewRoomView();
         }
      }
   }
}
