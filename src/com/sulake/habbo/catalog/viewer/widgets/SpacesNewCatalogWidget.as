package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_486:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_486 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_486)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_486.numSelectables)
            {
               _loc4_ = this.var_486.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_119[this.var_545]);
      ...
      {
         var _loc2_:int = this.var_682[this.var_545];
         var _loc3_:Offer = this.var_219[this.var_545][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_219[this.var_545][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_682[this.var_545] = (this.var_219[this.var_545] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         for each(_loc1_ in page.offers)
         {
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_64 || _loc2_.productType == ProductTypeEnum.const_74))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_486.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_219[this.var_545],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_682[this.var_545];
