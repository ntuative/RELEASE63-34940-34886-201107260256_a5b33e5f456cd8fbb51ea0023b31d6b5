package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1132:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1131.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1131 = null;
         }
         if(this.var_1132 != null)
         {
            this.var_1132.removeEventListener(WindowKeyboardEvent.const_198,this.windowKeyEventProcessor);
            this.var_1132 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1131 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1131 != null)
         {
            this.var_1131.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1132 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1132 != null)
         {
            this.var_1132.addEventListener(WindowKeyboardEvent.const_198,this.windowKeyEventProcessor);
         }
         return true;
      }
