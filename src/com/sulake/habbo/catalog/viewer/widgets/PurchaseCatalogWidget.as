package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2490:XML;
      
      private var var_979:IWindowContainer;
      
      private var var_646:IButtonWindow;
      
      private var var_3121:IButtonWindow;
      
      private var var_1849:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_980,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2495 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2491 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2492 = _loc3_.content as XML;
         }
      ...
      private function attachStub(param1:String, param2:int) : void
      {
         ...
         if(this.var_32.hasUserRight(null,param2))
         {
            switch(param1)
            {
               case Offer.const_823:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2495) as IWindowContainer;
                  break;
               case Offer.const_1293:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2491) as IWindowContainer;
                  break;
               case Offer.const_1183:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2492) as IWindowContainer;
                  break;
               default:
         ...
         else
         {
            switch(param2)
            {
               ...
               case HabboClubLevelEnum.const_42:
                  ...
                  {
                     _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2490) as IWindowContainer;
                  }
            }
         }
         if(_loc3_ != null)
         ...
         this.var_1848 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1847 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         ...
         this.var_646 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         this.var_1849 = window.findChildByName("ctlg_buy_club_button") as IButtonWindow;
         if(this.var_646 != null)
         {
            if(this.var_1497 != null)
            {
               this.var_646.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1497);
            }
            else
            {
               this.var_646.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1497);
               this.var_646.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onPurchase);
            }
            this.var_646.disable();
         }
         if(this.var_1849 != null)
         {
            this.var_1849.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBuyClub);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1848 != null)
         {
            ...
            this.var_1848.caption = "${catalog.purchase.price.credits}";
         }
         ...
         if(this.var_1847 != null)
         {
            ...
            this.var_1847.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1846 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         ...
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_105,page.pageId,this.var_1846);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_105 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_105,page.pageId,this.var_1846,param1.enableBuyAsGift);
         }
      }
      
      private function onBuyClub(param1:WindowMouseEvent) : void
      {
         (page.viewer.catalog as HabboCatalog).openCatalogPage(CatalogPageName.const_142,true);
