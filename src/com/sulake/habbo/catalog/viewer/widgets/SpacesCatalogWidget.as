package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1657:String = "default";
      ...
      private var var_1658:String = "1.1";
      
      private var var_1080:Dictionary;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1080 = this.parseElements(_loc2_.floors.pattern);
         this.var_1354 = this.parseElements(_loc2_.walls.pattern);
         this.var_1351 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1080)
                  {
                     _loc11_ = this.var_1080[_loc10_];
                     if(this.var_716.indexOf(_loc10_) == -1)
                     {
                        this.var_716.push(_loc10_);
                        this.var_1353.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1354[_loc8_] != null)
                  {
                     this.var_890.push(_loc8_);
                     this.var_1352.push(_loc3_);
                  }
                  else
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1351[_loc8_] != null)
                  {
                     this.var_889.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1657,this.var_1658,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1352[this.var_483];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1657);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1353[this.var_484];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1658);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_716[this.var_484];
         var _loc3_:Array = this.var_1080[_loc2_];
         if(_loc3_ != null && this.var_479 >= 0)
         {
            _loc11_ = _loc3_[this.var_479];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1353[this.var_484];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_890[this.var_483];
         var _loc6_:Array = this.var_1354[_loc5_];
         if(_loc6_ != null && this.var_480 >= 0)
         {
            _loc13_ = _loc6_[this.var_480];
            if(_loc13_ != null)
            {
               this.var_1657 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1352[this.var_483];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_889[this.var_481];
         var _loc9_:Array = this.var_1351[_loc8_];
         if(_loc9_ != null && this.var_482 >= 0)
         {
            _loc15_ = _loc9_[this.var_482];
            if(_loc15_ != null)
            {
               this.var_1658 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_111:
               ...
               if(this.var_484 < 0)
               {
                  this.var_484 = this.var_716.length - 1;
               }
               if(this.var_484 >= this.var_716.length)
               {
                  this.var_484 = 0;
               }
               this.var_479 = 0;
               this.var_1079 = 0;
               _loc5_ = this.var_716[this.var_484];
               _loc6_ = this.var_1080[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1079 = _loc6_.length;
               }
            ...
            case const_244:
               ...
               if(this.var_483 < 0)
               {
                  this.var_483 = this.var_890.length - 1;
               }
               if(this.var_483 == this.var_890.length)
               {
                  this.var_483 = 0;
               }
               this.var_480 = 0;
               this.var_1077 = 0;
               _loc7_ = this.var_890[this.var_483];
               _loc8_ = this.var_1354[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1077 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_481 < 0)
               {
                  this.var_481 = this.var_889.length - 1;
               }
               if(this.var_481 >= this.var_889.length)
               {
                  this.var_481 = 0;
               }
               this.var_482 = 0;
               this.var_1078 = 0;
               _loc9_ = this.var_889[this.var_481];
               _loc10_ = this.var_1351[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1078 = _loc10_.length;
               }
