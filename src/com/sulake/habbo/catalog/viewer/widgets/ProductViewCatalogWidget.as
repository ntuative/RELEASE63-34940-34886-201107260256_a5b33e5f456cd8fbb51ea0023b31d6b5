package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1775:Point;
      
      private var var_527:IItemGridWindow;
      
      private var var_1468:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_200.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_200 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1186 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_97 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_200 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_200 != null)
         {
            this.var_200.visible = false;
            this.var_528 = this.var_200.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_528 != null && _loc3_ != null)
            {
               this.var_200.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
         ...
         this.var_1775 = new Point(this.var_97.x,this.var_97.y);
         this.var_527 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1468 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1186.text = _loc5_;
         this.var_959.height = this.var_959.textHeight + 5;
         this.var_1186.y = this.var_959.y + this.var_959.height;
         this.var_1186.height = Math.max(130,this.var_1186.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_496:
                  ...
                  if(this.var_527 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_527,this.var_1468,this.var_2206);
               ...
               case Offer.const_436:
                  ...
                  if(this.var_200 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_74 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_199)
                     {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_340,AvatarAction.const_573);
                                 _loc18_.appendAction(AvatarAction.const_369,_loc9_.productClassId);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1775.x;
            this.var_97.y = this.var_1775.y;
            if(param3 != null)
            {
