package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_257)
         {
            this.var_257 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_257)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_257.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_257.setGlobalPosition(_loc6_.subtract(new Point(this.var_257.width / 2,this.var_257.height / 2)));
         this.var_257.visible = true;
         this.var_257.activate();
      }
