package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2075:String = "ctlg_";
      ...
      private var var_546:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1250:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_546 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1251);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1251);
      }
      ...
      {
         var _loc2_:String = const_2075 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1972:
               if(this.var_1250 == null)
               {
                  this.var_1250 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1250);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1773:
               ...
               break;
            case CatalogWidgetEnum.const_1800:
            ...
            case CatalogWidgetEnum.const_1907:
               ...
               break;
            case CatalogWidgetEnum.const_2052:
            ...
            case CatalogWidgetEnum.const_1955:
               ...
               break;
            case CatalogWidgetEnum.const_1931:
            ...
            case CatalogWidgetEnum.const_1791:
               ...
               break;
            case CatalogWidgetEnum.const_1974:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_546.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_546 != null)
         {
            return this.var_546.dispatchEvent(param1);
         }
         return false;
      }
