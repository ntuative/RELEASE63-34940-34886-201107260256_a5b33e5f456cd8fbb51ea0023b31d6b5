package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1106:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_215:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1106).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1106).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_93,MouseCursorType.const_950);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_950);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_215.select(this);
            this.var_536 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_536 != null && this.var_536 == param2)
         {
            _loc3_ = this.var_215.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_536 = null;
            }
