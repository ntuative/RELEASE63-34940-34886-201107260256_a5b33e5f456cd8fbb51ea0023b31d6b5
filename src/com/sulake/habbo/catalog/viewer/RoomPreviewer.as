package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_485:Number = 0.25;
      
      private static const const_1653:int = 64;
      
      private static const const_1651:int = 32;
      
      private static const const_1652:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_186,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_1010,this.onRoomObjectAdded);
      ...
      public function dispose() : void
      {
         ...
         {
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_186,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_1010,this.onRoomObjectAdded);
      ...
      public function reset() : void
      {
         ...
         this.var_348 = RoomObjectCategoryEnum.const_148;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         ...
         if(this._roomEngine != null)
         {
            if(this.var_348 == RoomObjectCategoryEnum.const_27 && this.var_1344 == param1)
            {
               return const_66;
            }
            this.reset();
            this.var_1344 = param1;
            this.var_348 = RoomObjectCategoryEnum.const_27;
            this.var_1644 = "";
            _loc4_ = this._roomEngine.activeRoomId;
            _loc5_ = this._roomEngine.activeRoomCategory;
            this._roomEngine.setActiveRoom(const_51,const_52);
            if(this._roomEngine.addObjectFurniture(const_51,const_52,const_66,param1,new Vector3d(const_724,const_723,0),param2,0,""))
            {
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_348 == RoomObjectCategoryEnum.const_26 && this.var_1344 == param1 && this.var_1644 == param3)
            {
               return const_66;
            }
            this.reset();
            this.var_1344 = param1;
            this.var_348 = RoomObjectCategoryEnum.const_26;
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            this.reset();
            this.var_1344 = 1;
            this.var_348 = RoomObjectCategoryEnum.const_29;
            this.var_1644 = param1;
            if(this._roomEngine.addObjectUser(const_51,const_52,const_66,new Vector3d(const_724,const_723,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1348 = getTimer();
               this.var_1347 = true;
      ...
      public function changeRoomObjectState() : void
      {
         ...
         {
            this.var_1347 = false;
            if(this.var_348 != RoomObjectCategoryEnum.const_29)
            {
               this._roomEngine.changeObjectState(const_51,const_52,const_66,this.var_348);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1348 + const_1652)
            {
               this.var_1348 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_51,const_52,const_66,this.var_348);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_51,const_52,const_243,param1,param2,this.var_1346);
            this._roomEngine.setRoomCanvasMask(const_51,const_52,const_243,true);
            _loc4_ = this._roomEngine.getRoomCanvasGeometry(const_51,const_52,const_243);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_51,const_52,const_66,this.var_348,const_243);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1345 >> 1),-(this.var_1070 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_51.width > this.var_1345 - this.var_51.width >> 1 || _loc3_.height - this.var_51.height > this.var_1070 - this.var_51.height >> 1 || this.var_51.width < 1 || this.var_51.height < 1)
               {
                  this.var_51 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         var _loc2_:IRoomGeometry = this._roomEngine.getRoomCanvasGeometry(const_51,const_52,const_243);
         if(this.var_51.width > this.var_1345 * (1 + const_485) || this.var_51.height > this.var_1070 * (1 + const_485))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.method_5();
               this.var_1346 = const_1651;
               this.var_2115 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_51.left >>= 2;
         ...
         else if(this.var_51.width << 1 < this.var_1345 * (1 + const_485) - 5 && this.var_51.height << 1 < this.var_1070 * (1 + const_485) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_2115)
            {
               _loc2_.performZoomIn();
               this.var_1346 = const_1653;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1070 - this.var_51.height >> 1;
         if(_loc4_ > 10)
         {
            _loc3_ += Math.min(15,_loc4_ - 10);
         }
         else if(this.var_348 != RoomObjectCategoryEnum.const_29)
         {
      ...
      public function updatePreviewRoomView() : void
      {
         ...
         if(this._roomEngine != null)
         {
            _loc1_ = this._roomEngine.getRoomCanvasScreenOffset(const_51,const_52,const_243);
            if(_loc1_ != null)
            {
               this.updatePreviewObjectBoundingRectangle(_loc1_);
               if(this.var_51 != null)
               {
                  _loc2_ = this.var_1346;
                  _loc1_ = this.validatePreviewSize(_loc1_);
                  _loc3_ = this.getCanvasOffset(_loc1_);
                  if(_loc3_ != null)
                  {
                     this._roomEngine.setRoomCanvasScreenOffset(const_51,const_52,const_243,_loc3_);
                  }
                  if(this.var_1346 != _loc2_)
                  {
                     this.var_51 = null;
                  }
               }
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_51 && param1.roomCategory == const_52 && param1.objectId == const_66 && param1.category == this.var_348)
         {
            this.var_51 = null;
            this.var_2115 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_586);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_993);
