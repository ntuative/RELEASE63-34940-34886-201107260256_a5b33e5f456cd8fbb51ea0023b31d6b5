package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2388:int = 10;
      ...
      private const const_2126:uint = 4.293848814E9;
      
      private const const_2125:uint = 4.294967295E9;
      
      private const const_1479:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1260 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_344,this.onMessageInputFocus);
         }
         this.var_1938 = true;
         this.var_1936 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_420,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1937 = _loc1_.stuffTypes;
            this.var_822 = _loc1_.boxTypes;
            this.var_821 = _loc1_.ribbonTypes;
            this.var_1261 = this.var_1937[0];
            this.var_389 = this.var_822[0];
            this.var_390 = this.var_821[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_390 > this.var_821.length - 1)
         {
            this.var_390 = 0;
         }
         if(this.var_389 < 0)
         {
            this.var_389 = this.var_822.length - 1;
         }
         if(this.var_389 > this.var_822.length - 1)
         {
            this.var_389 = 0;
         }
         var _loc1_:int = this.var_822[this.var_389] * 1000 + this.var_821[this.var_390];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1261,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1538 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1937)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1261);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_822[this.var_389]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_821[this.var_390]);
         this._catalog.purchaseProductAsGift(this.var_1537,this.var_1260,this.var_1539,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1537,this.var_1260,this.var_1539);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2618 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_266)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2388)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2618 = _loc2_.text;
      }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_283 == null || this.var_820 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1479;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2126) : uint(this.const_2125);
      }
      ...
      {
         this.var_1261 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1261;
               }
            }
            _loc4_++;
         }
