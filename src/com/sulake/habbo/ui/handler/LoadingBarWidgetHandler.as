package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_665);
         _loc1_.push(InterstitialEvent.const_533);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_118);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_374);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_665:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_118:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_374:
               this._container.events.dispatchEvent(param1);
         }
      }
