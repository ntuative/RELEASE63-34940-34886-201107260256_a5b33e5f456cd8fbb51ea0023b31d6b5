package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_240.events.addEventListener(NowPlayingEvent.const_107,this.onNowPlayingChanged);
            this.var_240.events.addEventListener(SongInfoReceivedEvent.const_101,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_228,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_228,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_627.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_627.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_240 != null)
         {
            this.var_240.events.removeEventListener(NowPlayingEvent.const_107,this.onNowPlayingChanged);
            this.var_240.events.removeEventListener(SongInfoReceivedEvent.const_101,this.onSongInfoReceivedEvent);
            this.var_240 = null;
         }
         this.var_1156 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_841);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_741);
         _loc1_.push(RoomWidgetFurniActionMessage.const_782);
         _loc1_.push(RoomWidgetFurniActionMessage.const_883);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1369);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_1008);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_746);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_740);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_2029);
         _loc1_.push(RoomWidgetPetCommandMessage.const_526);
         _loc1_.push(RoomWidgetPetCommandMessage.const_763);
         _loc1_.push(RoomWidgetUserActionMessage.const_635);
         _loc1_.push(RoomWidgetUserActionMessage.const_262);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_904);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_590)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_262 || param1.type == RoomWidgetUserActionMessage.const_635 || param1.type == RoomWidgetUserActionMessage.const_539)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_841:
            ...
            case RoomWidgetUserActionMessage.const_656:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1223,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_539:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_741:
            ...
            case RoomWidgetUserActionMessage.const_262:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_1008:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_746:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_740:
            ...
            case RoomWidgetUserActionMessage.const_657:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_763:
            ...
            case RoomWidgetPetCommandMessage.const_526:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_904:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_376);
               _loc6_.id = param1.id;
               ...
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1303;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1323);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_628)
                  {
                     _loc30_ = this.var_240.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_440) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_440.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_240.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_554)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_343);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_159)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_1004);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_937;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_962;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1914);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_627.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_627.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_1004);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_240 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_240.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_435,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_240 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_459,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
