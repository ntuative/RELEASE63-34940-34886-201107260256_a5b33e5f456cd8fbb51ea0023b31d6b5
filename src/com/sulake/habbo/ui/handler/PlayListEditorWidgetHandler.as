package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1441:IMessageEvent;
      
      private var var_1734:IMessageEvent;
      
      private var var_1735:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_176,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_107,this.processSoundManagerEvent);
      ...
      {
         this.var_1441 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1734 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1735 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1441);
         this._connection.addMessageEvent(this.var_1734);
         this._connection.addMessageEvent(this.var_1735);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1441);
               this._connection.removeMessageEvent(this.var_1734);
               this._connection.removeMessageEvent(this.var_1735);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_176,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_107,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_842,RoomWidgetPlayListModificationMessage.const_945,RoomWidgetPlayListModificationMessage.const_990,RoomWidgetPlayListPlayStateMessage.const_922,RoomWidgetPlayListUserActionMessage.const_995];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_842:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_939,_loc2_.id);
            ...
            case RoomWidgetPlayListModificationMessage.const_990:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_922:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_995:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_311:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_744,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_898,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_982));
               break;
            case PlayListStatusEvent.const_106:
               ...
               break;
            case PlayListStatusEvent.const_176:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_176));
               break;
            case NowPlayingEvent.const_107:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_107,_loc2_.id,_loc2_.position,_loc2_.priority));
               break;
