package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_948,RoomWidgetViralFurniMessage.const_1032,RoomWidgetViralFurniMessage.const_189];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_948:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_614);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_1032:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendViralFurniFoundMessage();
               }
               break;
            case RoomWidgetViralFurniMessage.const_189:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_570,RoomSessionViralFurniStatusEvent.const_602];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_570:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_934);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_602:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
