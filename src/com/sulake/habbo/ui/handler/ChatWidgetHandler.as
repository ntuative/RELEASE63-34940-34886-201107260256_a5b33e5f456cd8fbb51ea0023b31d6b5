package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_774:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_323 != null)
         {
            ...
            {
               _loc2_ = this.var_323.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_793,RoomWidgetChatSelectAvatarMessage.const_822];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_793:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_640);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_822:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_323.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_442.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_635.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_635.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_210)
                                    {
                                       this.var_323.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1184 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1184);
            }
            if(this.var_774 == null)
            {
               ...
               this.var_526.y = 0;
               this.var_526.z = 0;
               this.var_774 = _loc4_.getScreenPoint(this.var_526);
               this.var_1184 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_526.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_774.x || _loc8_.y != this.var_774.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_774,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_323)
         {
            _loc2_ = this.var_323.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1185.push(_loc2_);
            }
         }
      }
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_635.add(param1,_loc7_);
                  }
               }
            }
         }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(this.var_323)
            {
               this.var_323.add(_loc3_,param2);
            }
         }
      }
   }
