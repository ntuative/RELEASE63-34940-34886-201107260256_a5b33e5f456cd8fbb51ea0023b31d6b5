package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_798,RoomWidgetDimmerSavePresetMessage.const_1035,RoomWidgetDimmerChangeStateMessage.const_996,RoomWidgetDimmerPreviewMessage.const_971];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_798:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_1035:
               if(this.validateRights())
               {
            ...
            case RoomWidgetDimmerChangeStateMessage.const_996:
               ...
               break;
            case RoomWidgetDimmerPreviewMessage.const_971:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_630);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_630:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_930);
