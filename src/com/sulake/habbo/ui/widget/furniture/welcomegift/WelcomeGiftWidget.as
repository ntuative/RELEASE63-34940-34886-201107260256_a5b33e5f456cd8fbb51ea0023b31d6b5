package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_709:String = "welcome_gift_email_unverified";
      
      private const const_1122:String = "welcome_gift_email_verified";
      
      private const const_1601:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_709);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_709:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1050;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1050);
               break;
            ...
            case this.const_1601:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1050);
      ...
      {
         this.setViewState(this.const_1601);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_1026,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1308 ? this.const_1122 : this.const_709);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_601,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_1002,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_601,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_1002,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_601:
               this.var_1600 = param1.email;
               this.var_1308 = param1.isVerified;
               this.var_1050 = param1.allowEmailChange;
