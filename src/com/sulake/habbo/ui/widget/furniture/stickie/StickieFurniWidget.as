package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1566:int = 14;
      
      private static const const_1565:int = 500;
      
      private static const const_1474:Number = 100;
      ...
      protected var var_2284:String = "stickieui_container";
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1434 = param1.objectType;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2284,"",HabboWindowType.const_77,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1474,const_1473,2,2),null,0) as IWindowContainer;
         ...
         this.setColorButtons(this.var_27 && this.var_1434 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_522,this.var_239,this._text,this.var_363);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_522,this.var_239,this._text,this.var_363);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_923,this.var_239);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1565;
         if(_loc2_.numLines < const_1566)
         {
            return;
         }
