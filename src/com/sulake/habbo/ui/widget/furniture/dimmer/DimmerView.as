package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_653:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_77,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1474,const_1473,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_653 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1514 = _loc2_.light;
         if(this.var_446 != null)
         {
            this.var_446.setValue(this.var_1514);
         }
         this.var_604 = this.colors.indexOf(_loc2_.color);
         if(this.var_653 != null)
         {
            this.var_653.setSelectedColorIndex(this.var_604);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_653 != null)
         {
            this.var_653.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
