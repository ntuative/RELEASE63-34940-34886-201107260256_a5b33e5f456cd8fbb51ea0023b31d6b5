package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1579:int = 9;
      
      private static const const_1104:int = 10;
      
      private static const const_698:int = 25;
      
      private static const const_1583:int = 25;
      
      private static const const_1105:int = 4000;
      
      private static const const_1582:int = 6000;
      
      private static const const_1580:int = 3;
      
      private static const const_1578:int = 1;
      
      private static const const_699:int = 8;
      
      private static const const_475:int = 0;
      
      private static const const_1103:int = (const_699 + const_475) * const_119 + const_119;
      
      private static const const_476:int = 9;
      
      private static const const_1581:int = 40;
      ...
      private var var_2702:int = 150;
      
      private var var_254:int = 171.0;
      
      private var var_1031:int = 18;
      
      private var var_3093:int = 100;
      
      private var var_3092:int = 195;
      ...
      public function RoomChatWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:int, param7:Component)
      {
         ...
         this.var_42 = param2.createWindow("chat_container","",HabboWindowType.const_77,HabboWindowStyle.const_31,HabboWindowParam.const_48,new Rectangle(0,0,200,this.var_254 + RoomChatHistoryPulldown.const_88),null,0) as IWindowContainer;
         this.var_42.background = true;
         this.var_42.color = 33554431;
         this.var_42.tags.push("room_widget_chat");
         this.var_396 = param2.createWindow("chat_contentlist","",HabboWindowType.const_1238,HabboWindowStyle.const_48,0 | 0,new Rectangle(0,0,200,this.var_254),null,0) as IItemListWindow;
         this.var_42.addChild(this.var_396);
         this.var_135 = param2.createWindow("chat_active_content","",HabboWindowType.const_77,HabboWindowStyle.const_48,HabboWindowParam.const_65,new Rectangle(0,0,200,this.var_254),null,0) as IWindowContainer;
         this.var_135.clipping = false;
         this.var_396.addListItem(this.var_135);
         this.var_30 = new RoomChatHistoryViewer(this,param2,this.var_42,param3);
         this._baseUrl = param5.getKey("site.url");
         this.var_2702 = int(param5.getKey("chat.history.item.max.count","150"));
      ...
      override public function dispose() : void
      {
         ...
         while(this.var_290.length > 0)
         {
            _loc1_ = this.var_290.shift();
         }
         this.var_30.dispose();
         this.var_30 = null;
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1279 && this.var_1279 > 0)
         {
            this.var_1279 = -1;
            this.animationStart();
         }
         if(this.var_993)
         {
            _loc2_ = param1 / const_1583 * const_1580;
            ...
            {
               this.var_1031 = const_119;
               this.var_1029 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1279 = getTimer() + const_1105;
            }
         }
         if(this.var_30 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_997,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_521,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_910,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_846,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_997,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_521,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_910,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_846,this.onRoomViewUpdate);
      }
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1984 == 0)
            {
               this.var_1984 = param1.scale;
            }
            else
            {
               this.var_1030 = param1.scale / this.var_1984;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_841.x += param1.positionDelta.x / this.var_1030;
            this.var_841.y += param1.positionDelta.y / this.var_1030;
         }
         if(param1.rect != null)
         {
            if(this.var_30 == null)
            ...
            this.var_42.height = this.var_254 + this.var_30.pulldownBarHeight;
            this.var_396.width = this.var_42.width - this.var_30.scrollbarWidth;
            this.var_396.height = this.var_254;
            this.var_396.x = this.var_42.x;
            this.var_396.y = this.var_42.y;
            this.var_135.width = this.var_42.width - this.var_30.scrollbarWidth;
            this.var_135.height = this.var_254;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_79.length > const_1578 || this.historyViewerActive() && this.var_79.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_1031 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_79[0]);
            }
            else
            {
               this.var_1031 = const_119;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_475 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1582)
               {
                  _loc4_.timeStamp = _loc1_;
                  _loc2_ = _loc4_.screenLevel;
                  --_loc4_.screenLevel;
                  this.var_290.push(_loc4_);
               }
            }
            _loc3_--;
         }
      ...
      private function moveItemsUp(param1:int) : void
      {
         ...
         var _loc2_:* = null;
         var _loc4_:int = -1;
         var _loc5_:int = this.var_290.length - 1;
         while(_loc5_ >= 0)
         {
            _loc2_ = this.var_290[_loc5_];
            if(_loc2_ != null)
            {
               if(_loc4_ == -1)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_841.x) * this.var_1030;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_42.width / 2 - const_1104 + this.var_3093;
         var _loc6_:Number = this.var_42.width / 2 + const_1104 - this.var_30.scrollbarWidth - this.var_3092;
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_254 + this.var_42.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2702)
         {
            _loc2_ = this._itemList.shift();
            _loc3_ = this.var_290.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
               this.var_290.splice(_loc3_,1);
            }
            if(_loc2_.view != null)
            {
      ...
      {
         return "chat_" + this.var_2700.toString() + "_item_" + (this.var_2701++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_822,param1,param2,param4,param5);
      ...
      {
         var _loc2_:int = this.var_42.context.getDesktopWindow().height - 0 - const_1581;
         param1 = Math.min(param1,_loc2_);
         this.var_254 = param1 - this.var_42.y;
         this.var_42.height = this.var_254 + RoomChatHistoryPulldown.const_88;
         if(this.var_30 != null)
         {
            this.var_30.containerResized(this.var_42.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_254 = const_1103 + const_476;
         this.var_42.height = this.var_254 + this.var_30.pulldownBarHeight;
         this.var_396.width = this.var_42.width - this.var_30.scrollbarWidth;
         this.var_396.height = this.var_254;
         this.var_135.width = this.var_42.width - this.var_30.scrollbarWidth;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1236)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_1103)
         {
            if(_loc1_ <= this.var_254 + this.var_42.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1983 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1983 = false;
         }
