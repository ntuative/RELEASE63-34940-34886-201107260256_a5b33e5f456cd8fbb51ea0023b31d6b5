package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2399:int = 1000;
      ...
      private var var_724:IWindow;
      
      private var var_337:Number;
      
      private var var_415:ITextWindow;
      
      private var var_236:Timer;
      
      private var var_725:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_116 = param2;
         this._widget = param1;
         this.var_236 = new Timer(this.const_2399);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_116.isActive)
         {
            ...
            this.var_724.width = _loc2_ * this.var_337;
         }
         else
         {
            this.var_724.width = 0;
            this.var_236.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_415 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_415 == null)
            {
               return;
            }
         ...
         if(!this.var_116.isActive)
         {
            this.var_415.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_116.secondsLeft > 86400)
         {
            this.var_415.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_415.text;
            _loc2_ = Math.floor(this.var_116.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_415.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_415.text;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_77,HabboWindowStyle.const_31,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_725 = this._window.findChildByName("effect_hilite");
            this.var_725.visible = false;
         }
         this.setTimeLeft();
         this.var_724 = this._window.findChildByName("loader_bar");
         if(this.var_724 != null)
         {
            this.var_337 = this.var_724.width;
            this.var_236.start();
            this.onUpdate();
         }
