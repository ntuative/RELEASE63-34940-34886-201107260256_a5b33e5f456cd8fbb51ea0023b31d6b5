package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3091:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3091 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_400:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_74,this.var_157,this.var_2695++,this);
               break;
            case RoomWidgetEnum.const_346:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_74,this.var_157,this);
               break;
            case RoomWidgetEnum.const_607:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_74,this.var_157,this._catalog);
               break;
            case RoomWidgetEnum.const_545:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_74,events,this.var_157);
               break;
            ...
            case RoomWidgetEnum.const_674:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_74,this.var_157,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_509:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_74,this.var_157);
               break;
            case RoomWidgetEnum.const_592:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_74,this.var_157);
               break;
            case RoomWidgetEnum.const_125:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_74,this.var_157);
               break;
            ...
            case RoomWidgetEnum.const_124:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_157,this.var_74,this);
               break;
            ...
            case RoomWidgetEnum.const_596:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_74,this.var_157,this._catalog);
               break;
