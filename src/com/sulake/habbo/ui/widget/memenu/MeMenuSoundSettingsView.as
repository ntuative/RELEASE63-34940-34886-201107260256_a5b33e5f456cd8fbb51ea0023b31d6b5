package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_974:MeMenuSoundSettingsSlider;
      ...
      private var var_950:Number = 1.0;
      ...
      {
         this.var_950 = param1.volume;
         if(this.var_974 != null)
         {
            this.var_974.setValue(this.var_950);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_976 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_973 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_972 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_975 = (_loc5_.content as BitmapData).clone();
         }
         this.var_974 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_881));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_950 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_975);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_976);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_972);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_973);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_814);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_877);
         }
