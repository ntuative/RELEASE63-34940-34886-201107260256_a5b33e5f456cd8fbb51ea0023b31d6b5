package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_957:String = "PLSV_ADD_SONGS";
      
      public static const const_1298:String = "PLSV_START_PLAYBACK";
      
      public static const const_532:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_532)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_463[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_463[const_957];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_463.add(const_532,_loc1_);
