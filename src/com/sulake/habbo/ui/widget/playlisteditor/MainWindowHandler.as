package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private var var_1123:IBorderWindow;
      
      private var var_1122:IBorderWindow;
      
      private var var_595:MusicInventoryGridView;
      
      private var var_920:PlayListEditorItemListView;
      
      private var var_264:MusicInventoryStatusView;
      
      private var var_356:PlayListStatusView;
      
      private var var_2176:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_240 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_968,PlayListEditorWidgetAssetsEnum.const_935,PlayListEditorWidgetAssetsEnum.const_515,PlayListEditorWidgetAssetsEnum.const_637,PlayListEditorWidgetAssetsEnum.const_837];
         ...
         this.var_920 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
      ...
      public function destroy() : void
      {
         if(this.var_240)
         {
            this.var_240.stop(HabboMusicPrioritiesEnum.const_451);
            this.var_240 = null;
         }
         if(this.var_595)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1123,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_968);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_935)
         {
            this.assignWindowBitmapByAsset(this.var_1122,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_935);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_515)
         {
            this.var_264.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_515));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_637)
         {
            this.var_264.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_637));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_837)
         {
            this.var_356.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_837);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1123 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         this.var_1122 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_2176 = this.var_1123.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_2175 = this.var_1122.getChildByName("playlist_scrollbar") as IScrollbarWindow;
         if(this.var_2176 == null)
         {
      ...
      {
         return this.var_1123.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      
      private function getPlayListEditorItemList() : IItemListWindow
      {
         return this.var_1122.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      
      private function getMusicInventoryStatusContainer() : IWindowContainer
      {
         return this.var_1123.getChildByName("preview_play_container") as IWindowContainer;
      }
      
      private function getPlayListStatusContainer() : IWindowContainer
      {
         return this.var_1122.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_356.selectView(PlayListStatusView.const_532);
         }
         else if(_loc1_.length > 0)
         {
            this.var_356.selectView(PlayListStatusView.const_1298);
         }
         else
         {
            this.var_356.selectView(PlayListStatusView.const_957);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_264.show();
            this.var_264.selectView(MusicInventoryStatusView.const_940);
         }
         else if(this.var_240.getSongDiskInventorySize() <= const_1699)
         {
            this.var_264.show();
            this.var_264.selectView(MusicInventoryStatusView.const_854);
         }
         else
         {
            this.var_264.hide();
      ...
      private function updatePlaylistEditorView() : void
      {
         ...
         this.var_920.refresh(_loc2_,_loc3_);
      }
      ...
      public function onPlayListUpdated() : void
      {
         ...
         this.var_2175.visible = _loc1_.length > const_1697;
      }
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_2176.visible = this.var_595.itemCount > const_1698;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_107:
               this.selectPlayListStatusViewByFurniPlayListState();
               this.var_920.setItemIndexPlaying(param1.position);
               if(param1.id != -1)
               {
      ...
      {
         return this.var_240.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_451) != -1;
      }
   }
}
