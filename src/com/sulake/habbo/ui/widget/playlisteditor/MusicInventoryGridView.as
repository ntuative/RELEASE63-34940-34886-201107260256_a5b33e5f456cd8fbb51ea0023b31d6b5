   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_620.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_110.playButtonState = MusicInventoryGridItem.const_1341;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_110 != null)
         {
            this.var_110.playButtonState = MusicInventoryGridItem.const_579;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_170;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_110.playButtonState == MusicInventoryGridItem.const_579)
               {
                  this.var_110.playButtonState = MusicInventoryGridItem.const_1345;
            ...
            {
               _loc4_ = this.var_620.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
