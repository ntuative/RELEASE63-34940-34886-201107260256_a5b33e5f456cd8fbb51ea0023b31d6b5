package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_854:String = "MISV_BUY_MORE";
      
      public static const const_940:String = "MISV_PREVIEW_PLAYING";
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_463[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      ...
      {
         this.blitBackgroundImage(const_940,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_854,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_463.add(const_940,_loc1_);
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_515));
         ...
         if(_loc1_ != null)
         {
            this.var_463.add(const_854,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_637));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_463[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
