package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1509:int = 16;
      
      private static const const_690:int = 4;
      
      private static const const_1516:uint = 14342874;
      
      private static const const_1513:uint = 3815994;
      
      private static const const_1517:uint = 2085362;
      
      private static const const_1518:uint = 39616;
      
      private static const const_1514:uint = 10513106;
      
      private static const const_1506:uint = 8734654;
      
      private static const const_1507:uint = 9094430;
      
      private static const const_1515:uint = 6200576;
      
      private static const const_1511:String = "happiness";
      
      private static const const_1512:String = "experience";
      ...
      {
         if(this.var_55 == null || this.var_49 == null || this.var_108 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_49.width,this.var_108.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_49.width < this.var_108.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1511,param1.nutrition,param1.nutritionMax,const_1518,const_1517);
         this.updateStateElement(const_1512,param1.experience,param1.experienceMax,const_1506,const_1514);
         this.updateStateElement(const_1519,param1.energy,param1.energyMax,const_1515,const_1507);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1508,const_1509,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1516);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1513);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_690,_loc7_.width - 2,_loc7_.height - 2 - const_690);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_690);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_216 && this.var_216.getPetId() == this.var_520)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1895,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_429,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1074 + const_1073;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1073;
            }
         }
         this.var_108.height = _loc4_ + const_1074;
         this.updateWindow();
      }
   }
}
