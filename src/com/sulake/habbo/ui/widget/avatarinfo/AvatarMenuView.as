package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1042:uint = 1;
      
      protected static const const_1041:uint = 2;
      
      protected static var var_1439:uint = const_1042;
      
      private static const const_1617:uint = 16744755;
      
      private static const const_1618:uint = 16756591;
      
      private static const const_1114:int = 8;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_733:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1724)
         {
            ...
            {
               this.var_733 = const_1041;
            }
            else
            {
               this.var_733 = var_1439;
            }
         }
         if(this.var_733 == const_1042)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1114;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1114;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2070) : uint(const_1039);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1618;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1617;
               }
            }
         }
         if(_loc3_)
