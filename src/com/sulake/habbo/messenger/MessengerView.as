package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1677:ConversationView;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1677.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1100 = new ConversationsTabView(this.var_156,this.var_16);
         this.var_1100.refresh();
         this.var_1021 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_1021.addEventListener(WindowKeyboardEvent.const_198,this.onMessageInput);
         this.var_1677 = new ConversationView(this.var_156,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_977,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1390,true);
         this.var_16.center();
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_1021.text = "";
         this.var_156.conversations.addMessageAndUpdateView(new Message(Message.const_998,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
