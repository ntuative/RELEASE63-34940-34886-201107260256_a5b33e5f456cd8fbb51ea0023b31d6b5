package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1552:int = 20;
       
      
      private var var_156:HabboMessenger;
      
      private var var_2569:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         ...
         this.var_2569 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1085 + const_1552)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1553;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_544 == null || _loc1_.id != this.var_544.id)
         {
            this.var_544 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_544.followingAllowed)
         {
      ...
      private function refreshList() : void
      {
         ...
         this.var_64.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_544.messages.length - const_1085);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_544.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_544.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_998 || param3.type == Message.const_879 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_544.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_156.send(new FollowFriendMessageComposer(this.var_544.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_905)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1235)
         {
            return 4288269465;
         }
         return 4291611852;
