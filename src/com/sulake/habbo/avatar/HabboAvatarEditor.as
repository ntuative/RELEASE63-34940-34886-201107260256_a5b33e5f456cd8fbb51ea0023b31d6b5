package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1536:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1535:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_542:HabboAvatarEditorManager;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_542 = param2;
         this.var_990 = this.var_542.avatarRenderManager.getFigureData(AvatarType.const_122);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_656["null"] = new FigureData(this);
         this.var_656["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_656["null"];
         var _loc3_:FigureData = this.var_656["null"];
         _loc2_.loadAvatarData(const_1536,FigureData.const_90);
         _loc3_.loadAvatarData(const_1535,FigureData.FEMALE);
         this.var_119 = new Map();
         this.var_541 = new Map();
         this.var_119.add(AvatarEditorFigureCategory.const_1030,new BodyModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_55,new HeadModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_256,new TorsoModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_764,new LegsModel(this));
         ...
         this.var_541.add(AvatarEditorSideCategory.const_114,new WardrobeModel(this));
         this.var_541.add(AvatarEditorSideCategory.const_569,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_801 != param3)
         {
            this.var_801 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_656[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_1030);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_541.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_656[this.var_1016];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         else
         {
            ...
            this.var_542.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_801 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_692)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_542.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_542.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_542.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_2040)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_801 >= _loc6_.clubLevel))
               {
      ...
      {
         return this.var_542.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_801 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_541.getValue(AvatarEditorSideCategory.const_114);
      }
