package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_2828:String = null;
      
      private var var_2829:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1156)
         {
            ...
            if(this.var_859)
            {
               for each(_loc2_ in this.var_859)
               {
                  _loc2_.dispose();
               }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_295.length == 1 && this.var_103 == this.var_1805)
         {
            return this.var_103 + this.var_570 + this.var_699 % 4;
         }
      ...
      {
         if(param3 != this.var_2827 || param2 != this.var_2828 || param1 != this.var_2829)
         {
            this.var_2827 = param3;
            this.var_2828 = param2;
            this.var_2829 = param1;
            this.var_2065 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1433 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1433)
            {
               this.var_48.dispose();
            }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_362.push(new ActiveActionData(param1,param2,this.var_699));
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_570 = "";
         this.var_295 = this._structure.sortActions(this.var_362);
         if(this.var_295 == null)
         {
         ...
         {
            this.var_803 = this._structure.getCanvasOffsets(this.var_295,this._scale,this.var_103);
            for each(_loc4_ in this.var_295)
            {
               this.var_570 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_369)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1606 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1606 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_295)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_993 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_377 || _loc1_.actionType == AvatarAction.const_293 || _loc1_.actionType == AvatarAction.const_437)
               {
                  this.var_993 = true;
               }
            }
