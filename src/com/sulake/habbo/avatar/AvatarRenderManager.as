package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2403:String = "hd-99999-99999";
      ...
      private var var_919:PaletteManager;
      
      private var var_733:String;
      
      private var var_355:Map;
      
      private var var_263:AvatarAssetDownloadManager;
      
      private var var_2173:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_733 = RenderMode.const_2009;
         ...
         this.var_125.add(AvatarType.const_122,_loc4_);
         ...
         this.var_125.add(AvatarType.const_57,_loc4_);
         ...
         this.var_919 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_263)
         {
            this.var_263.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_354.init();
         this.var_919.init();
         _loc2_ = this.var_125.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_125.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_125.getValue(AvatarType.const_122) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_263 == null)
               {
                  ...
                  this.var_263 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_263.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1087)
         {
            if(this.var_2985 && this.var_2987 && this.var_2986)
            {
               this.var_1087 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_263.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_263.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_125.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_263.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2173)
         {
            this.var_2173 = new AvatarFigureContainer(this.const_2403);
         }
         this.var_263.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2173,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1941)
         {
            _loc6_ = !this.var_354.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_354.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_125.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_125.getValue(AvatarType.const_57);
      ...
      {
         var _loc3_:AvatarStructure = this.var_125.getValue(AvatarType.const_122) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_125.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
