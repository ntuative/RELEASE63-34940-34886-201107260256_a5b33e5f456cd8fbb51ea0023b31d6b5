package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2124:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1573:IAvatarImage;
      ...
      private var var_493:AvatarImageBodyPartContainer;
      ...
      private var var_2925:ByteArray;
      
      private var var_2924:ImageData;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_897 == GeometryType.const_1305 && param1 == GeometryType.const_1356 || this.var_897 == GeometryType.const_1356 && param1 == GeometryType.const_1305)
         {
            this.var_897 = param1;
            this.var_98 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_416.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_991)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_535)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1573.getFigure(),_loc5_,this.var_897,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_493 = _loc10_.getImageContainer(_loc4_);
         if(this.var_493 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_493 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_416);
            if(this.var_493 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_493,_loc4_);
         }
         this.var_493.offset = _loc8_;
         return this.var_493;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_98)
         {
            this.var_98 = this._structure.getCanvas(this._scale,this.var_897);
            if(!this.var_98)
            {
               return null;
            }
            this.var_2926 = new Point(0,this.var_98.height - int(this.var_98.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1853[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_771 || _loc10_ == AvatarAction.const_437;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1672 = this.var_140.bodyPartId;
               this.var_203 = this.var_140.partType;
               this.var_2147 = this.var_140.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_140.flippedPartType != this.var_203)
                     {
                        this.var_203 = this.var_140.flippedPartType;
                     }
                  }
               }
               this.var_1673 = this._scale + "_" + this.var_140.action.assetPartDefinition + "_" + this.var_203 + "_" + this.var_2147 + "_" + _loc5_ + "_" + this._frame;
               this.var_490 = this._assets.getAssetByName(this.var_1673) as BitmapDataAsset;
               if(this.var_490 == null)
               {
                  this.var_1673 = this._scale + "_std_" + this.var_203 + "_" + this.var_2147 + "_" + _loc5_ + "_0";
                  this.var_490 = this._assets.getAssetByName(this.var_1673) as BitmapDataAsset;
               }
               if(!(!this.var_490 || !this.var_490.content))
               {
                  ...
                  {
                     this.var_1118 = this._structure.renderManager.paletteManager.getPalette(this.var_140.paletteMapId);
                     if(this.var_1118 != null)
                     {
                        this.var_1097 = this.var_490.content as BitmapData;
                        this.var_204 = new BitmapData(this.var_1097.width,this.var_1097.height);
                        this.var_2925 = this.var_1118.colorize(this.var_1097.getPixels(this.var_1097.rect));
                        this.var_204.setPixels(this.var_204.rect,this.var_2925);
                     }
                     else
                     {
                        this.var_204 = (this.var_490.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1672 == AvatarBodyPartType.const_256 || this.var_1672 == AvatarBodyPartType.const_1964 || this.var_1672 == AvatarBodyPartType.const_1997) && this.var_140.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_204.colorTransform(this.var_204.rect,this.var_140.color.colorTransform);
                  }
                  if(this.var_140.isBlendable)
                  {
                     this.var_204.colorTransform(this.var_204.rect,this.var_140.blendTransform);
                  }
                  this.var_1096 = this.var_490.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_61)
                     {
                  ...
                  this.var_2924 = new ImageData(this.var_204,this.var_1096,_loc7_);
                  this.var_1095.push(this.var_2924);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_1095,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2926.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_61)
            {
         ...
         _loc8_ = this.var_1095.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1095.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
