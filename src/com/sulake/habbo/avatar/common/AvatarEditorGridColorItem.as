package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_726.width,this.var_726.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_726,this.var_726.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1099.width,this.var_1099.height,true,0);
            _loc5_ = this.var_1099.clone();
            ...
            if(this.var_968)
            {
               switch(this.var_968.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_816;
                     _loc4_.visible = true;
                     break;
