package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2918:uint;
      
      private var var_2917:uint;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_765 = new ColorTransform(this.var_2057,this.var_2059,this.var_2058,this._alphaMultiplier);
         this.var_1363 = this.generatePaletteMapForGrayscale(this.var_2917,this.var_2918);
      }
      ...
      {
         return this.var_1363.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1363.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1363.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1363.getValue("alphas") as Array;
      }
