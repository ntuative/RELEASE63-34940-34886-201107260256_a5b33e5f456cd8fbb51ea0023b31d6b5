package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      private var var_176:AvatarRenderManager;
      ...
      {
         if(param1 == null || this.var_569 == null)
         {
            return;
         }
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_569.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1594.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_693.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_569.indexOf(param3) == -1)
                  {
                     this.var_569.push(param3);
                  }
               }
            }
         }
