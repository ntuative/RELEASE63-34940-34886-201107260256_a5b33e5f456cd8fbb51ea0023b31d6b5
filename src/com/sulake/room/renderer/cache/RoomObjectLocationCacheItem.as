package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_372:Vector3d = null;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1760 || param1.getUpdateID() != this.var_2432)
         {
            this.var_2432 = param1.getUpdateID();
            if(param2.updateId != this.var_1760 || _loc4_.x != this.var_1196.x || _loc4_.y != this.var_1196.y || _loc4_.z != this.var_1196.z)
            {
               this.var_1760 = param2.updateId;
               this.var_1196.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2431 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_372.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_372.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_372.x = Math.round(this.var_372.x);
            this.var_372.y = Math.round(this.var_372.y);
         }
         return this.var_372;
      }
   }
