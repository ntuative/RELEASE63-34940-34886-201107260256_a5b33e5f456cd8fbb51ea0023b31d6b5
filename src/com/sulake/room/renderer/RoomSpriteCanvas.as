package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_735:Point = new Point(0,0);
      
      private static const const_394:int = 50;
      
      private static const const_1701:int = 50;
      
      private static const const_1169:Number = 60;
      
      private static const const_1700:Number = 50;
      ...
      private var var_308:BitmapDataCache;
      
      private var var_740:RoomObjectCache;
      
      private var var_598:Array;
      
      private var var_743:Array;
      
      private var var_1692:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2994:Number = -1.0E7;
      
      private var var_2991:Number = -1.0E7;
      ...
      private var var_3107:Boolean = false;
      
      private var var_2996:Array;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_307 = new Sprite();
         this.var_307.mouseEnabled = false;
         this.var_118 = new Sprite();
         this.var_118.name = "canvas";
         this.var_118.mouseEnabled = false;
         this.var_307.addChild(this.var_118);
         this.var_118.mouseEnabled = true;
         this.var_118.doubleClickEnabled = true;
         this.var_118.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_118.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         this._geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         this.var_308 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_740 = new RoomObjectCache(_loc6_);
         this.var_765 = new ColorTransform();
         this.var_739 = new Matrix();
      ...
      {
         this.var_596.x -= param1 - this.var_741;
         this.var_741 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_596.y -= param1 - this.var_744;
         this.var_744 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1114 = true;
            if(this.var_164 != null && !this.var_307.contains(this.var_164))
            {
               this.var_307.addChild(this.var_164);
               this.var_118.mask = this.var_164;
            }
         }
         else if(!param1 && this.var_1114)
         {
            ...
            if(this.var_164 != null && this.var_307.contains(this.var_164))
            {
               this.var_307.removeChild(this.var_164);
               this.var_118.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_307.numChildren > 0)
            {
               this.var_307.removeChildAt(0);
            }
            this.var_307 = null;
         }
         this.var_118 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_743.length)
            {
               this.cleanSprite(this.var_743[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_743 = [];
         }
      ...
      {
         this.var_740.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2178 = !this.var_2178;
         ...
         if(this.var_599 != this.var_2995 || this.var_597 != this.var_2997)
         {
            _loc8_ = true;
         }
         if(this.var_118.x != this.var_741 || this.var_118.y != this.var_744)
         {
            this.var_118.x = this.var_741;
            this.var_118.y = this.var_744;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_598.sortOn("z",0 | 0);
         if(_loc5_ < this.var_598.length)
         {
            this.var_598.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_598[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2995 = this.var_599;
         this.var_2997 = this.var_597;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1691 > 0)
         {
            _loc2_ = param1 - this.var_1691;
            if(_loc2_ > const_1169 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2993 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_921;
               if(this.var_921 == const_394 + 1)
               {
                  this.var_539 = _loc2_;
                  this.var_2177 = this.var_2992;
               }
               else if(this.var_921 > const_394 + 1)
               {
                  _loc3_ = Number(this.var_921 - const_394);
                  this.var_539 = this.var_539 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2177 = this.var_2177 * (_loc3_ - 1) / _loc3_ + Number(this.var_2992) / _loc3_;
                  if(this.var_921 > const_394 + const_1701)
                  {
                     this.var_921 = const_394;
                     if(!this.var_1391 && this.var_539 > const_1169)
                     {
                        this.var_1391 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1391 && this.var_539 < const_1700)
                     {
                        this.var_1391 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_740.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_740.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2178 && this.var_1391);
         ...
         _loc13_ += int(this.var_599 / 2);
         _loc14_ += int(this.var_597 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_741;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_744;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_598.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_741;
                     _loc17_.y = _loc20_ - this.var_744;
      ...
      {
         if(param1 < this.var_599 && param1 + param3 >= 0 && (param2 < this.var_597 && param2 + param4 >= 0))
         {
            if(!this.var_3107)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_599)
         {
            param3 -= this.var_599 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_597)
         {
            param4 -= this.var_597 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2996)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1125)
         {
            return null;
         }
         return this.var_118.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_743.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1125)
         {
            this.var_118.addChild(_loc3_);
            ++this.var_1125;
         }
         else
         {
            this.var_118.addChildAt(_loc3_,param2);
         }
         ++this.var_922;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_118.removeChildAt(param1);
                  this.var_743.push(_loc4_);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_922 || this.var_922 == 0)
         {
            _loc4_ = this.var_1125 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_598[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_308.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_308.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_308.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_739.identity();
            if(flipH)
            {
               this.var_739.scale(-1,1);
               this.var_739.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_739.scale(1,-1);
               this.var_739.translate(0,data.height);
            }
            finalData.draw(data,this.var_739);
            if(name.length > 0)
            {
               this.var_308.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_735);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_765.redMultiplier = tR;
            this.var_765.greenMultiplier = tG;
            this.var_765.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_765);
            if(name.length > 0)
            {
               this.var_308.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_741;
         param2 -= this.var_744;
         this.var_596.x = param1;
         this.var_596.y = param2;
         if(this.var_1390 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2179;
         }
         this.var_2179 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1390;
         return this.var_2179;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_599 / 2;
         var _loc12_:Number = param2 - this.var_597 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2180,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_742.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_742.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2994 || param2 != this.var_2991)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_742.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_742.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_424 != null && param1 != null)
         {
            this.var_424.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_424 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_424.getKey(_loc1_);
            _loc3_ = this.var_424.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1692.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1390 == 0)
         {
            this.checkMouseHits(this.var_596.x,this.var_596.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1390 = 0;
         ++this.var_2180;
      }
