package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1636:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1635:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3099 = new Array();
         this.var_179 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1636() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1635() as ByteArray;
