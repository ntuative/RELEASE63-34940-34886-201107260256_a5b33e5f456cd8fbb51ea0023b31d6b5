package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1716:String = "_SELECTOR";
      
      private static const const_1717:String = "_CONTENT";
       
      
      protected var var_1159:ITabSelectorWindow;
      
      protected var var_2287:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1159 = findChildByTag(const_1716) as ITabSelectorWindow;
            if(this.var_1159 != null)
            {
               this.var_1159.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2287 == null)
         {
            this.var_2287 = findChildByTag(const_1717) as IWindowContainer;
         }
      ...
      {
         return !!this.var_850 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1159.numSelectables;
      }
