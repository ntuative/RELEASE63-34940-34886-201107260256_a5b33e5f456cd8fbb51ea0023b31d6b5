package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2740 = _loc2_.textWidth;
         this.var_2739 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_399 != _loc2_.color : this.var_399 != null && this.var_399 != PropertyDefaults.const_1028) ? new PropertyStruct(PropertyDefaults.const_431,this.var_399,PropertyStruct.const_147,true) : PropertyDefaults.const_1397);
         if(this.var_43)
         {
            if(this.var_43.left != PropertyDefaults.const_770)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_285,this.var_43.left,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_805);
            }
            if(this.var_43.top != PropertyDefaults.const_795)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_43.top,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_864);
            }
            if(this.var_43.right != PropertyDefaults.const_885)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_272,this.var_43.right,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_987);
            }
            if(this.var_43.bottom != PropertyDefaults.const_847)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_265,this.var_43.bottom,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_848);
            }
         }
         else
         {
