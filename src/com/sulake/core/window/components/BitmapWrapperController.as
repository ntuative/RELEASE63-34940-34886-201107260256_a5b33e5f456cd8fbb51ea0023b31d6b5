package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_611 != PropertyDefaults.const_1278)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_932,this.var_611,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1842);
         }
         if(this.var_943 != PropertyDefaults.const_1316)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_760,this.var_943,PropertyStruct.const_54,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_760:
                  this.var_943 = _loc2_.value as String;
                  break;
            }
         }
