package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1224:String = null;
      
      private var var_1876:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1224 == param2)
         {
            return;
         }
         param1.var_1224 = param2;
         param1.var_1876 = null;
         if(param1.var_1224 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1224);
            param1.var_1876 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_947.indexOf(param1) > -1)
         {
            this.var_799 = param1;
         }
      }
      ...
      {
         return this.var_799 == LinkTarget.const_31 ? defaultLinkTarget : this.var_799;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1876;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1231)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1014,this.var_799,PropertyStruct.const_54,true,PropertyDefaults.const_947));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_1014)
            {
