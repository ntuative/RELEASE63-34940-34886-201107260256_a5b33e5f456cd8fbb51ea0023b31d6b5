package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_617)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1038,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_2054);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1409)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_938,param1.toolTipDelay,PropertyStruct.const_290,true));
         }
         else
         {
