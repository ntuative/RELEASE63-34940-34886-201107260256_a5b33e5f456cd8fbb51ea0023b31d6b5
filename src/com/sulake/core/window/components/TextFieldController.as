package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1721:uint = 500;
      
      protected var var_1422:String = "";
      
      protected var var_1423:Boolean = false;
      
      protected var var_850:Boolean = false;
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_850 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_835,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1998);
         _loc1_.push(this.var_1423 != PropertyDefaults.const_1304 ? new PropertyStruct(PropertyDefaults.const_833,this.var_1423,PropertyStruct.const_37,true) : PropertyDefaults.const_1844);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1261 ? new PropertyStruct(PropertyDefaults.const_878,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1984);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1266 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_2037);
         return _loc1_;
      }
