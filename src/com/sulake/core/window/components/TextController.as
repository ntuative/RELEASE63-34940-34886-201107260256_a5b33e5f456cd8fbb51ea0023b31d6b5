package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1430:Dictionary = createPropertySetterTable();
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_819 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_941 * this.maxScrollH,this.var_608 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_953,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1195));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1407 ? new PropertyStruct(PropertyDefaults.const_768,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1383) : PropertyDefaults.const_2030);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1200 ? new PropertyStruct(PropertyDefaults.const_1229,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1193) : PropertyDefaults.const_2000);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1028) ? new PropertyStruct(PropertyDefaults.const_431,this._field.textColor,PropertyStruct.const_147,true) : PropertyDefaults.const_1397);
         _loc1_.push(this.var_455 != TextStyleManager.const_215 ? new PropertyStruct(PropertyDefaults.const_412,this.var_455,PropertyStruct.const_54,true,PropertyDefaults.const_912) : PropertyDefaults.const_1317);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_770 ? new PropertyStruct(PropertyDefaults.const_285,this.var_43.left,PropertyStruct.const_36,true) : PropertyDefaults.const_805);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_795 ? new PropertyStruct(PropertyDefaults.const_294,this.var_43.top,PropertyStruct.const_36,true) : PropertyDefaults.const_864);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_885 ? new PropertyStruct(PropertyDefaults.const_272,this.var_43.right,PropertyStruct.const_36,true) : PropertyDefaults.const_987);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_847 ? new PropertyStruct(PropertyDefaults.const_265,this.var_43.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_848);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1368 ? new PropertyStruct(PropertyDefaults.const_852,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1788);
