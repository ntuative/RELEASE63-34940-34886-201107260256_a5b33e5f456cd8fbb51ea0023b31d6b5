package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_375)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1386)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_939;
         if(this.var_939 != param1)
         {
            if(this.var_939 != null)
            {
               if(!this.var_939.disposed)
               {
                  this.var_939.deactivate();
               }
            }
            this.var_939 = param1;
