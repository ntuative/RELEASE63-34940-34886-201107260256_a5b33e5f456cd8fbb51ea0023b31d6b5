package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1232:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_449)
         {
            this.var_449.removeEventListener(WindowEvent.const_268,this.scrollBarEventProc);
            this.var_449.removeEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            this.var_449 = null;
         }
         if(this.var_1232)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1232)
         {
            this.var_1232 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_449)
         {
            ...
            if(this.var_449)
            {
               this.var_449.addEventListener(WindowEvent.const_268,this.scrollBarEventProc);
               this.var_449.addEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            }
         }
         return this.var_449;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_305)
         {
            this.hideScrollBar();
         }
      }
