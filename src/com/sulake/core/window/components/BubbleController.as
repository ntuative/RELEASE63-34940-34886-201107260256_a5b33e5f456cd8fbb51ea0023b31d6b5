package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2119:String = "_POINTER_UP";
      
      private static const const_2120:String = "_POINTER_DOWN";
      
      private static const const_2117:String = "_POINTER_LEFT";
      
      private static const const_2118:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_791,this._direction,PropertyStruct.const_54,true));
         }
         else
         {
         ...
         if(this.var_878 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_851,this.var_878,PropertyStruct.const_36,true));
         }
         else
         {
