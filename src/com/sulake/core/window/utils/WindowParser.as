package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2294:String = "_INCLUDE";
      
      public static const const_2172:String = "_TEMP";
      
      private static const const_1449:String = "layout";
      
      private static const name_6:String = "window";
      
      private static const const_1052:String = "variables";
      
      private static const const_1051:String = "filters";
      
      private static const const_683:String = "name";
      
      private static const const_1451:String = "style";
      
      private static const const_684:String = "params";
      
      private static const const_1452:String = "tags";
      ...
      private static const const_1441:String = "visible";
      
      private static const const_1448:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1378:String = "blend";
      
      private static const const_1442:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1440:String = "treshold";
      
      private static const const_1454:String = "children";
      
      private static const const_1443:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1446:String = "height_min";
      
      private static const const_1445:String = "height_max";
      
      private static const const_682:String = "true";
      
      private static const const_200:String = "0";
      
      private static const const_1453:String = "$";
      
      private static const const_1444:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1450:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1447:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1418:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1418,this.var_1417);
         this.var_1147 = new Dictionary();
         this.var_1713 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1147,this.var_1713);
         this.var_2261 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1447,const_50);
         return param1.replace(const_1450,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1418)
            {
               delete this.var_1418[_loc1_];
            }
            for(_loc1_ in this.var_1417)
            {
               delete this.var_1417[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1449)
         {
            _loc8_ = param1.child(const_1052);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1051).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1418[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_683,variables,"")));
         style = uint(this.parseAttribute(xml,const_1451,variables,style));
         params = uint(this.parseAttribute(xml,const_684,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1452,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_200));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_200));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_200));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_200));
         visible = this.parseAttribute(xml,const_1441,variables,visible.toString()) == const_682;
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1448,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1444);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1052)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1443,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1446,variables,window.limits.minHeight));
         ...
         blend = Number(this.parseAttribute(xml,const_1378,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1442,variables,window.clipping.toString()) == const_682;
         ...
         list = xml.child(const_1051).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1417[param1.type];
