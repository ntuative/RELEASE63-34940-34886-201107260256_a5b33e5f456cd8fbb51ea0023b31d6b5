package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_3082 = param3 == const_284 || param3 == const_166 || param3 == const_258 || param3 == const_307;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_284:
               ...
               _loc1_ = "<var key=\"" + this.var_634 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_307:
               ...
               break;
            case const_147:
               _loc1_ = "<var key=\"" + this.var_634 + "\" value=\"" + "0x" + uint(this.var_199).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_634 + "\" value=\"" + this.var_199 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
