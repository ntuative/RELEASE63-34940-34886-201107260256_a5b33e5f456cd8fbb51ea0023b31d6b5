package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_587:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_729:String = "{";
      
      private static const const_730:String = "}";
      
      private static const const_1685:String = "/*";
      
      private static const const_1684:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_215],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_215] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_587.indexOf(_loc4_.name) == -1)
            {
               var_587.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_730);
         if(countSubStrings(param1,const_729) != countSubStrings(param1,const_730))
         {
            throw new Error("Mismatching amount of \"" + const_729 + "\" versus \"" + const_730 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1685) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1684) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_729)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
