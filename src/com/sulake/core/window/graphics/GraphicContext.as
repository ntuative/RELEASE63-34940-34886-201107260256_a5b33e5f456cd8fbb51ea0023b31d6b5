package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2057:uint = 0;
      
      public static const const_820:uint = 1;
      
      public static const const_1259:uint = 2;
      
      public static const const_999:uint = 4;
      
      public static const const_1988:uint = 8;
      
      public static const const_1975:uint = 16;
      
      public static const const_2265:uint = 64;
      
      public static const const_2329:uint = 128;
      
      public static const const_1412:uint = 256;
      
      protected static var var_615:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1988:
               ...
               break;
            case GraphicContext.const_1975:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_999:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1412:
               break;
         ...
         if(this.var_944)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2283,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2283,16777215);
                  }
                  var_366 += bitmap.width * bitmap.height * 4;
               }
