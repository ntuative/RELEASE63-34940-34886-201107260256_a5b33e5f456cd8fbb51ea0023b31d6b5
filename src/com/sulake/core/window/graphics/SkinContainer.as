package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1170:uint = 8;
      
      private static const const_1702:String = "skin";
      
      private static const const_1705:String = "bitmap";
      
      private static const const_1706:String = "fill";
      
      private static const const_1704:String = "text";
      
      private static const const_1703:String = "label";
      
      private static const const_1707:String = "shape";
      ...
      private var var_2184:Dictionary;
      
      private var var_3007:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2184 = new Dictionary();
         this.var_3007 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2184,this.var_3007);
         this.var_3006 = new Dictionary();
         this.var_3005 = new Dictionary();
         StateCodeTable.fillTables(this.var_3006,this.var_3005);
         this.var_497 = new Dictionary();
         this.var_497[const_1702] = BitmapSkinRenderer;
         this.var_497[const_1705] = BitmapDataRenderer;
         this.var_497[const_1706] = FillSkinRenderer;
         this.var_497[const_1704] = TextSkinRenderer;
         this.var_497[const_1703] = LabelRenderer;
         this.var_497[const_1707] = ShapeSkinRenderer;
         this.var_497[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_497[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_367 == null)
         {
            var_367 = new Array();
            var_367.push(WindowState.const_71);
            var_367.push(WindowState.const_94);
            var_367.push(WindowState.const_97);
            var_367.push(WindowState.const_58);
            var_367.push(WindowState.const_93);
            var_367.push(WindowState.const_91);
            var_367.push(WindowState.const_89);
            var_367.push(WindowState.const_104);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3054 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2184[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1129[param1] == null)
         {
            this.var_1129[param1] = new Array(const_1170);
         }
         this.var_1129[param1][param2] = param3;
         if(this.var_1130[param1] == null)
         {
            this.var_1130[param1] = new Array(const_1170);
         }
         this.var_1130[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1129[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1130[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_103)
