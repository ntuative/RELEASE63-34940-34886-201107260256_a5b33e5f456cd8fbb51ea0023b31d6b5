   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_645;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_330;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_634;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_379;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_623;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_361 = SkinLayoutEntity.const_645;
                  break;
               case "move":
                  _loc5_.var_361 = SkinLayoutEntity.const_330;
                  break;
               case "strech":
                  _loc5_.var_361 = SkinLayoutEntity.const_634;
                  break;
               case "tiled":
                  _loc5_.var_361 = SkinLayoutEntity.const_379;
                  break;
               case "center":
                  _loc5_.var_361 = SkinLayoutEntity.const_623;
            }
         }
