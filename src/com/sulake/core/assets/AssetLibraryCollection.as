package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_510:AssetLibrary;
      
      protected var _manifest:XML;
      
      protected var _name:String;
      
      private var var_615:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1155 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_510 = new AssetLibrary("lib-" + this.var_615++);
         this.var_31.push(this.var_510);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1155;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_615++);
      ...
      {
         return this.var_510.loadFromResource(param1,param2);
      }
      ...
      {
         return this.var_510.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_510.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_510.createAsset(param1,param2);
      }
      ...
      {
         return this.var_510.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_510.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_510.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_31.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_510.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_31.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
