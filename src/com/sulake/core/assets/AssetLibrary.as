package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_2134:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_584:uint = 0;
      
      private static var var_1085:Array = new Array();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_721 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1154);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_721 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1085.splice(var_1085.indexOf(this),1);
            --var_584;
            this.var_583 = null;
            this.var_1088 = null;
            this.var_185 = null;
      ...
      {
         if(this.var_721 == param1.url && this.var_1087)
         {
            if(!this.var_1086 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_720);
            }
            this.var_1086 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1315));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_185)
         {
            delete this.var_185[_loc1_];
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1250,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1269,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1418,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_185[struct.assetName] == null)
                  {
                     ++this.var_488;
                     this.var_489.push(struct.assetName);
                  }
                  this.var_185[struct.assetName] = asset;
               }
               else
               {
      ...
      {
         var _loc2_:IAsset = this.var_185[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_489.length ? this.getAssetByName(this.var_489[param1]) : null;
      }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_185)
         {
            _loc3_ = this.var_185[_loc2_];
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_185)
         {
            if(this.var_185[_loc2_] == param1)
            {
               return this.var_489.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_185[param1] != null || (this.var_720 != null ? this.var_720[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_185[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_185[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_2134.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_185)
            {
               if(this.var_185[_loc2_] == param1)
               {
                  this.var_489.splice(this.var_489.indexOf(_loc2_),1);
                  delete this.var_185[_loc2_];
                  --this.var_488;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_487.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_487[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_487[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_487)
         {
            _loc3_ = AssetTypeDeclaration(this.var_487[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_487)
         {
            _loc4_ = AssetTypeDeclaration(this.var_487[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_720 = _loc2_.resource;
         this.var_721 = _loc2_.url;
         if(this.var_1086)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_720);
         }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_683) && _loc3_.attribute(const_683).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_721 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_720[param1]);
                     _loc6_ = _loc3_.child(const_1154);
