package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2080:uint = 1;
      
      protected static const const_2079:uint = 2;
      
      protected static const const_2081:uint = 4;
      
      protected static const const_2082:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1774:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1406:Boolean = false;
      
      public static const const_1863:int = 2;
      
      private static var var_1028:Array = new Array();
      
      private static var var_839:Array = new Array();
      ...
      protected var var_3069:String = "";
      
      protected var var_3071:String = "";
      ...
      protected var var_3139:uint = 0;
      
      protected var var_3070:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1406)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_839[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_839.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_839.length < const_1863 && false)
            {
               _loc1_ = var_1028.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1153 ? uint(this.var_1429 - this.var_2281) : uint(getTimer() - this.var_2281);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_435,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_44.close();
            }
      ...
      {
         if(this.var_1152 && !_disposed)
         {
            this.var_1152 = false;
            if(!this.var_1153 && this.var_267)
            {
               this.var_1429 = -1;
               this.var_2281 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1153 && !_disposed && this.var_1430 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_267,const_1774 - this.var_1430);
            if(this.var_3070)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_435 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_435,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_435,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_435))
               {
         ...
         if(this.var_513 == LibraryLoader.const_2082)
         {
         ...
         if(this.var_513 == LibraryLoader.name_5)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_435,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_720 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_720.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_435,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_435,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
