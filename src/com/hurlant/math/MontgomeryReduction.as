package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2152 = param1.invDigit();
         this.var_2151 = this.var_2152 & 32767;
         this.var_2931 = this.var_2152 >> 15;
         this.var_2932 = 131071;
         this.var_2933 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_200) > 0)
         {
